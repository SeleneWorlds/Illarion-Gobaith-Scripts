...
--Charakter-Trigger 
    ...
    autonpcfunctions.AddTraderTrigger("[Oo]live", "She beh oomie orc - half oomie, half orc. Buts meh nebbur hab trusted hers muchs. Meh nub understand why Chief Rugh does!"); 
    ...
    autonpcfunctions.AddTraderTrigger("[Kk]ar.*kish", "#me hits her own chest with her fist '"..thisNPC.name..", dis beh meh, yubba!'"); 
    autonpcfunctions.AddTraderTrigger("[Gg]ruknug", "Yoo talking 'bout mehs bruddah, Gruknug? He beh upstairs, guarding da othur gate!"); 
...
--SONSTIGE TRIGGER 
    ...
    autonpcfunctions.AddTraderTrigger("Or.*c.*", "#me hits his chest with his right fist and grunts 'Hurrr, Orcs ob Dar'krest beh strrongest! Praise father and holy mountain!'"); 
    autonpcfunctions.AddTraderTrigger("Or.*k.*", "#me schlägt mit seiner rechten Faust auf seine Brust 'Hurrr, Orks von Dar'krest die stärksten sein! Ehre für unseren Vater und heiligen Berg!'"); 
