...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(100 ,18  ,20,10 ,25  ,{3,4},{44,66},0   ,0       ); -- basic metalshield
    trader_functions.AddTraderItem(300 ,20  ,25,15 ,25  ,{3,4},{44,66},0   ,0       ); -- advanced metalshield
    trader_functions.AddTraderItem(400 ,186 ,15,20 ,15  ,{3,4},{44,66},0   ,0       ); -- round shield
    trader_functions.AddTraderItem(150 ,19  ,19,15 ,25  ,{3,4},{44,66},0   ,0       ); -- (medium) metalshield
    trader_functions.AddTraderItem(250 ,230 ,25,10 ,25  ,{3,4},{44,66},0   ,0       ); -- mace
    trader_functions.AddTraderItem(200 ,78  ,15,20 ,10  ,{3,4},{44,66},0   ,0       ); -- short sword
    trader_functions.AddTraderItem(300 ,2701,25,10 ,25  ,{3,4},{44,66},0   ,0       ); -- longsword
    trader_functions.AddTraderItem(100 ,27  ,25, 5 ,25  ,{3,4},{44,66},0   ,0       ); -- cheap dagger
    trader_functions.AddTraderItem(200 ,190 ,25,10 ,25  ,{3,4},{44,66},0   ,0       ); -- ornate dagger
    trader_functions.AddTraderItem(100 ,202 ,15,10 ,15  ,{3,4},{44,66},0   ,0       ); -- steel cap
    trader_functions.AddTraderItem(150 ,187 ,25,10 ,25  ,{3,4},{44,66},0   ,0       ); -- steel hat
    trader_functions.AddTraderItem(1200,101 ,10,50 ,5   ,{4,6},{44,66},0   ,0       ); -- chain shirt
    trader_functions.AddTraderItem(30  ,312 ,50,0  ,30  ,{5,7},{77,90},0   ,0); -- wooden shovel
    trader_functions.AddTraderItem(30  ,24  ,5 ,0  ,30  ,{5,7},{77,90},0   ,0); -- shovel
    trader_functions.AddTraderItem(30  ,2763,5 ,0  ,30  ,{5,7},{77,90},0   ,0); -- pickaxe
    trader_functions.AddTraderItem(30  ,23  ,3 ,0  ,30  ,{5,7},{77,90},0   ,0); -- hammer
    trader_functions.AddTraderItem(50  ,2751,20,0  ,20  ,{5,7},{77,90},0   ,0); -- crucible pincers
    trader_functions.AddTraderItem(40  ,2140,10,3  ,10  ,{4,5},{77,90},0   ,0); -- tongs
    trader_functions.AddTraderItem(30  ,311 ,3 ,0  ,30  ,{5,7},{77,90},0   ,0); -- glass blow pipe

    TraderCopper=2000;

    functions.AddTraderTrigger("[Gg]reetings","Welcome. How can I help you?");
    functions.AddAdditionalTrigger("[Hh]ello");
    functions.AddAdditionalText("Good day. Do you need something? I have cheap wares!");
    functions.AddTraderTrigger("[Gg]rü[sß]+e","Willkommen. Kann ich euch helfen?");
    functions.AddAdditionalTrigger("[Hh]allo");
    functions.AddAdditionalText("Guten Tag? Braucht ihr etwas? Ich habe billige Waren");
    functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","A trader I am, that's right. I trade different kinds of wares.");
    functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Ich bin Händler, das ich richtig. Ich handel mit verschiedensten Waren.");
    functions.AddTraderTrigger("[Ww]hat.+sell","I sell mostly smithed weapons.");
    functions.AddTraderTrigger("[Ww]as.+verkauf","Ich verkaufe geschmiedete Waffen.");
    functions.AddTraderTrigger("[Tt]ell.+[Ss]omething","Once upon a time, I came here. Now I am here. Isn't that interesting?");
    functions.AddTraderTrigger("[Ee]rzähl.+[Ww]as","Vor langer Zeit, kam ich hier her. Jetzt bin ich da. Ist das nicht interessant?");
    ...
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Schönen Tag.");
    ...
    functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Mein Name ist "..thisNPC.name..".");
    functions.AddTraderTrigger("I'm .+","Nice to meet you.");
    functions.AddTraderTrigger("[Ii]ch.+[Bb]in","Freut mich euch kennen zu lernen");
