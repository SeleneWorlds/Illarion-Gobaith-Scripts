...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(120 ,356 ,100 ,7  ,50 ,{5,7},{77,90},0   ,0); -- Hut
    trader_functions.AddTraderItem(150 ,55  ,100 ,15 ,50 ,{5,7},{77,90},0   ,0); -- Umhang
    trader_functions.AddTraderItem(120 ,2295,100 ,12 ,50 ,{5,7},{77,90},0   ,0); -- Handschuhe
    trader_functions.AddTraderItem(50  ,97  ,100 ,0  ,80 ,{5,7},{77,90},0   ,0); -- Tasche
    trader_functions.AddTraderItem(30  ,312 ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Holz Kelle
    trader_functions.AddTraderItem(35  ,24  ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Schaufel
    trader_functions.AddTraderItem(25  ,258 ,10  ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Dreschflegel
    trader_functions.AddTraderItem(25  ,271 ,10  ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Sense
    trader_functions.AddTraderItem(35  ,74  ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Axt
    trader_functions.AddTraderItem(20  ,51  ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Eimer
    trader_functions.AddTraderItem(20  ,121 ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Ofenschieber
    trader_functions.AddTraderItem(20  ,118 ,5   ,0  ,50 ,{5}  ,{77,90},0   ,0); -- Nudelholz
    trader_functions.AddTraderItem(2   ,249 ,5   ,0  ,500,{3}  ,{33},0   ,0); -- Getreide
    trader_functions.AddTraderItem(5   ,728 ,10  ,0  ,500,{3}  ,{33},0   ,0); -- Hopfen Samen
    trader_functions.AddTraderItem(2   ,2917,10  ,0  ,500,{3}  ,{33},0   ,0); -- Tomaten Samen
    trader_functions.AddTraderItem(2   ,291 ,10  ,0  ,500,{3}  ,{33},0   ,0); -- Kohl Setzling
    trader_functions.AddTraderItem(2   ,2494,10  ,0  ,500,{3}  ,{33},0   ,0); -- Karotten Samen

    TraderCopper=5000;

    functions.AddTraderTrigger("[Gg]reetings","Welcome to Greenbriar! Can I help you?");
    functions.AddTraderTrigger("[Hh]ello","A good day to you! What do you want to buy?");
    functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","I am "..thisNPC.name..", once I was one of Greenbriar's traders!");
    --npc.base.functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","I am "..thisNPC.name..", one of Greenbriar's traders!");
    functions.AddTraderTrigger("[Tt]ell.+[Gg]reenbriar","It was Crosis, leader of the Evergreen halflings, who animated all the other halflings to build the Briary bridge.");
    functions.AddTraderTrigger("[Tt]ell.+[Cr]osis","His group of halflings built the Briary bridge.");
    functions.AddTraderTrigger("[Ww]ho.+[Cr]osis","Crosis lead the Evergreen halflings to this land.");
    functions.AddTraderTrigger("[Ww]hat.+[Gg]reenbriar","Once, Greenbriar was a peacefull little town not far from here. But the peacefull times, in which all live together in harmony are gone.");
    ...
    functions.AddTraderTrigger("[Ww]here.+[Gg]reenbriar","Go to the west, over the bridge and follow the path.");
    --npc.base.functions.AddTraderTrigger("[Ww]here.+[Gg]reenbriar","You are already in Greenbriar! Welcome!");
    functions.AddTraderTrigger("[Ww]hat.+[Bb]riary.+bridge","The Briary bridge was built by the Evergreen halflings, the first people around here.");
    functions.AddTraderTrigger("[Ww]here.+[Bb]riary.+bridge","Go to the south.");
    --npc.base.functions.AddTraderTrigger("[Ww]here.+[Bb]riary.+bridge","It's north of this beautiful town!");
    functions.AddTraderTrigger("[Ww]ho.+[Ee]vergreen.+halflings","The Evergreen halflings are a group of halflings that founded Greenbriar.");
    functions.AddTraderTrigger("[Ww]hat.+sell","Oh, I sell clothes, tools and seeds Want to see my list?");
    functions.AddTraderTrigger("[Ww]hat.+[Cc]lothe","I have really nice hats, gloves and capes.");
    functions.AddTraderTrigger("[Ww]hat.+[Tt]ool","I have axes, scythes, shovels and so on. For more ask for my list of wares");
    functions.AddTraderTrigger("[Ww]hat.+[Ss]eed","I have seeds of grain, cabbage, carrots and tomatos.");
    functions.AddTraderTrigger("[Tt]ell.+[Ss]omething","We halflings discovered this beautiful island when we walked around in the east. It were the Evergreen halflings who built the Briary bridge.");
    functions.AddTraderTrigger("[Gg]oodbye","Have a nice day!");
    functions.AddTraderTrigger("[Bb]ye","Good bye!");
    functions.AddTraderTrigger("[Ff]arewell","Bye!");
    ...
    functions.AddTraderTrigger("[Gg]rü[ßs]+e","Grüß' dich!");
    functions.AddTraderTrigger("[Hh]allo","Huhu!");
    functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Ich bin "..thisNPC.name..", früher war ich einer von Greenbriars Händlern!");
    --npc.base.functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Ich bin "..thisNPC.name..", einer von Greenbriars Händlern!");
    functions.AddTraderTrigger("[Ww]as.+verkauf","Oh, ich verkaufe Kleidung, Werkzeuge und Samen. Willst du meine Liste sehen?");
    functions.AddTraderTrigger("[Ww]as.+[Kk]leidung","Ich hab sehr schöne Hüte, Umhänge und Handschuhe.");
    functions.AddTraderTrigger("[Ww]as.+[Ww]erkzeuge","Ich hab Äxte, Sensen, Schaufeln und so weiter. Frag nach meiner Warenliste wenn du es genau wissen willst.");
    functions.AddTraderTrigger("[Ww]as.+[Ss]ame","Ich habe Samen von Getreide, Kohl, Karotten und Tomaten.");
    functions.AddTraderTrigger("[Ee]rzähl.+[Ee]twas","Weisst Du, wie wir Halblinge diese Insel entdeckt haben? Das geschah, als wir im Osten herumgewandert sind.");
    functions.AddTraderTrigger("[Ee]rzähl.+[Gg]reenbriar","Crosis, der Anführer der Evergreen Halblinge hat den Bau der Briary Brücke veranlasst.");
    functions.AddTraderTrigger("[Ee]rzähl.+[Cr]osis","Er hat die Briary Brücke bauen lassen, mit seinen Halblingen.");
    functions.AddTraderTrigger("[Ww]er.+[Cr]osis","Crosis hat eine Gruppe von Halblingen angeführt: die Evergreen Halblinge.");
    functions.AddTraderTrigger("[Ww]as.+[Gg]reenbriar","Einst war Greenbriar ein wunderschöne, friedlicher Ort. Aber Missgunst und Unmut hat sich unter den Bewohnern breit gemacht und den Freiden vertrieben.");
    ...
    functions.AddTraderTrigger("[Ww]o.+[Gg]reenbriar","Geh nach Westen, über die Brücke und folge einfach dem Pfad.");
    --npc.base.functions.AddTraderTrigger("[Ww]o.+[Gg]reenbriar","Du bist mitten in Greenbriar! Willkommen!");
    functions.AddTraderTrigger("[Ww]as.+[Bb]riary.+[Bb]rücke","Die Briary Brücke wurd' damals von den Evergreen Halblingen gebaut.");
    functions.AddTraderTrigger("[Ww]o.+[Bb]riary.+[Bb]rücke","Sie liegt genau westlich von hier!");
    --npc.base.functions.AddTraderTrigger("[Ww]o.+[Bb]riary.+[Bb]rücke","Sie liegt genau nördlich von hier!");
    functions.AddTraderTrigger("[Ww]er.+[Ee]vergreen.+[Hh]alblinge","Die Evergreen Halblinge haben die Brücke bauen lassen und diese schöne Insel besiedelt.");
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Du gehst schon? Ach schade... Na, dann mach's mal gut!");
    functions.AddTraderTrigger("[Bb]is.+[Bb]ald","Ich hoffe, du kommst mal wieder vorbei!");
    functions.AddTraderTrigger("[Ww]er.+du?","Ich werde "..thisNPC.name.." genannt.");
    functions.AddTraderTrigger("Ich bin .+","Huhu! Schön, dich kennenzulernen!");
...
function M.receiveText(texttype, message, originator)
    if functions.BasicNPCChecks(originator,2) then
        if (functions.LangOK(originator,TradSpeakLang)==true) then
            ...
            if (Status==0) then Status=M.QuestSpecial(originator, message) end
            ...
            if (Status==1) then -- Verkauf von mehreren Items erfolgreich // npc.base.trader_functions.Selling of multible items succeed
                gText="Du willst "..Values[1].." "..world:getItemName(Values[2],0).." kaufen? Bitte sehr, macht dann"..trader_functions.MoneyText(0,Values[3],Values[4],Values[5],TraderLang)..".";
            ...
            elseif (Status==6) then -- Verkauf eines einzelnen Items erfolgreich // npc.base.trader_functions.Selling of a single item succeed
                gText=functions.GenusSel(Values[2],"Ein","Eine","Ein").." "..world:getItemName(Values[2],0).." ist es, was du kaufen willst? Bitte sehr, das macht"..trader_functions.MoneyText(0,Values[3],Values[4],Values[5],TraderLang)..".";
            ...
            elseif (Status==9) then -- Einkauf von mehreren Items erfolgreich // npc.base.trader_functions.Buying of multible items succeed
                gText="Du willst "..Values[1].." "..world:getItemName(Values[2],0).." verkaufen? Ich gebe dir"..trader_functions.MoneyText(0,Values[3],Values[4],Values[5],TraderLang)..".";
            ...
            elseif (Status==13) then -- Einkauf eines einzelnen Items erfolgreich // npc.base.trader_functions.Buying of a single item succeed
                gText=functions.GenusSel(Values[2],"Ein","Eine","Ein").." "..world:getItemName(Values[2],0).." ist es, was du verkaufen willst? Ich geb' dir"..trader_functions.MoneyText(0,Values[3],Values[4],Values[5],TraderLang)..".";
...
function M.QuestSpecial(originator, message)
    local retVal=0;
