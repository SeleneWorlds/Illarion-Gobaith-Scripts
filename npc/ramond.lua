...
module("npc.ramond", package.seeall)
...
function initializeNpc()
    ...
    npc.base.trader_functions.AddTraderItem(24  ,24  ,5 ,0  ,5 ,{2,3},{11,22},0   ,0       ); -- shovel
    ...
    npc.base.functions.AddTraderTrigger("[Jj]ob","I take care of this graveyard");
    npc.base.functions.AddTraderTrigger("[Bb]eruf","Ich kümmere mich um diesen Friedhof");
    npc.base.functions.AddTraderTrigger("[Gg]ravejard","This is the place where everybody finds the eternal sleep.");
    npc.base.functions.AddTraderTrigger("[Ff]riedhof","Das ist der Ort wo jeder seine ewige Ruhe finden kann.");
    npc.base.functions.AddTraderTrigger("[Mm]ission","My friend, I am a simple man with no needs.");
    npc.base.functions.AddTraderTrigger("[Aa]uftrag","Mein Freund, ich bin ein einfach Mann der nichts braucht.");
    npc.base.functions.AddTraderTrigger("[Qq]uest","My friend, I am a simple man with no needs.");
    npc.base.functions.AddTraderTrigger("[Nn]eed.+help","All you could do for me, is helping me with the garden work. Like taking care of the graves.");
    npc.base.functions.AddTraderTrigger("[Bb]rauch.+[Hh]ilfe","Alles was ihr für mich tun könntet, ist mir bei der Garten Arbeit zu helfen. Zum Beispiel könntet ihr euch etwas um die Gräber kümmern.");
    npc.base.functions.AddTraderTrigger("[Gg]rave","I take care of them as good as I can, but sometimes they even scare me.");
    npc.base.functions.AddTraderTrigger("[Gg]r[aä]b","Ich kümmere mich um sie, so gut ich kann, aber machmal erschrecken sie mich.");
    npc.base.functions.AddTraderTrigger("[Ss]care","During these nights without moon, I could swear that a body left a grave and walked away!");
    npc.base.functions.AddTraderTrigger("[Ss]reck","Während der Nächte ohne Mond, könnte ich schwören das ein Körper sein Grab verlassen hat und weg gelaufen ist!");
    npc.base.functions.AddTraderTrigger("[Ww]hat.+sell","I cannot offer you much, only maybe one of my old shovels.");
    npc.base.functions.AddTraderTrigger("[Ww]as.+verkaufen","I kann nicht viel Anbieten. Allerhöchstens vielleicht meine alten Schaufeln.");
    ...
    npc.base.functions.AddTraderTrigger("[Ww]ho.+[Yy]ou","I am Brother "..thisNPC.name);
    npc.base.functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Ich bin Bruder "..thisNPC.name);
    npc.base.functions.AddTraderTrigger("[Dd]ungeon below [Gg]raveyard","What!? I know nothing about it.");
    npc.base.functions.AddAdditionalTrigger("[Tt]empel below [Gg]raveyard");
    npc.base.functions.AddAdditionalText("What!? I know nothing about it.");
    npc.base.functions.AddTraderTrigger("[Hh]öhle.+unter.+[Ff]riedhof","Was? Davon weis ich nichts.");
    npc.base.functions.AddAdditionalTrigger("[Tt]empel.+unter.+[Ff]riedhof");
    npc.base.functions.AddAdditionalText("Was?! Davon wüsste ich doch!");
