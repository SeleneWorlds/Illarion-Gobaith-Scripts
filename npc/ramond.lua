...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(24  ,24  ,5 ,0  ,5 ,{2,3},{11,22},0   ,0       ); -- shovel

    TraderCopper=0;

    functions.AddTraderTrigger("[Hh]ello","Greetings my friend.");
    functions.AddAdditionalTrigger("[Gg]reetings");
    functions.AddAdditionalText("A pleasure to meet you, friend.");
    functions.AddTraderTrigger("[Hh]allo","Grüße mein Freund.");
    functions.AddAdditionalTrigger("[Gg]rü[sß]+e");
    functions.AddAdditionalText("Ist mir eine Freude euch zu treffen.");
    functions.AddTraderTrigger("[Jj]ob","I take care of this graveyard");
    functions.AddTraderTrigger("[Bb]eruf","Ich kümmere mich um diesen Friedhof");
    functions.AddTraderTrigger("[Gg]ravejard","This is the place where everybody finds the eternal sleep.");
    functions.AddTraderTrigger("[Ff]riedhof","Das ist der Ort wo jeder seine ewige Ruhe finden kann.");
    functions.AddTraderTrigger("[Mm]ission","My friend, I am a simple man with no needs.");
    functions.AddTraderTrigger("[Aa]uftrag","Mein Freund, ich bin ein einfach Mann der nichts braucht.");
    functions.AddTraderTrigger("[Qq]uest","My friend, I am a simple man with no needs.");
    functions.AddTraderTrigger("[Nn]eed.+help","All you could do for me, is helping me with the garden work. Like taking care of the graves.");
    functions.AddTraderTrigger("[Bb]rauch.+[Hh]ilfe","Alles was ihr für mich tun könntet, ist mir bei der Garten Arbeit zu helfen. Zum Beispiel könntet ihr euch etwas um die Gräber kümmern.");
    functions.AddTraderTrigger("[Gg]rave","I take care of them as good as I can, but sometimes they even scare me.");
    functions.AddTraderTrigger("[Gg]r[aä]b","Ich kümmere mich um sie, so gut ich kann, aber machmal erschrecken sie mich.");
    functions.AddTraderTrigger("[Ss]care","During these nights without moon, I could swear that a body left a grave and walked away!");
    functions.AddTraderTrigger("[Ss]reck","Während der Nächte ohne Mond, könnte ich schwören das ein Körper sein Grab verlassen hat und weg gelaufen ist!");
    functions.AddTraderTrigger("[Ww]hat.+sell","I cannot offer you much, only maybe one of my old shovels.");
    functions.AddTraderTrigger("[Ww]as.+verkaufen","I kann nicht viel Anbieten. Allerhöchstens vielleicht meine alten Schaufeln.");
    functions.AddTraderTrigger("[Ww]hat buy","I fear, my friend, that there is nothing I would want to buy right now.");
    functions.AddTraderTrigger("[Ww]as.+%skauf","Ich fürchte, mein Freund, es gibt nichts was ich im Augenblick von euch kaufen würde.");
    functions.AddTraderTrigger("[Ww]ho.+[Yy]ou","I am Brother "..thisNPC.name);
    functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Ich bin Bruder "..thisNPC.name);
    functions.AddTraderTrigger("[Dd]ungeon below [Gg]raveyard","What!? I know nothing about it.");
    functions.AddAdditionalTrigger("[Tt]empel below [Gg]raveyard");
    functions.AddAdditionalText("What!? I know nothing about it.");
    functions.AddTraderTrigger("[Hh]öhle.+unter.+[Ff]riedhof","Was? Davon weis ich nichts.");
    functions.AddAdditionalTrigger("[Tt]empel.+unter.+[Ff]riedhof");
    functions.AddAdditionalText("Was?! Davon wüsste ich doch!");
    functions.AddTraderTrigger("[Bb]ye","Walk in peace, my friend.");
    functions.AddAdditionalTrigger("[Ff]are.*well");
    functions.AddAdditionalText("Walk in peace, my friend.");
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Geh in Frieden, mein Freund.");
    functions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    functions.AddAdditionalText("Geh in Frieden, mein Freund.");
