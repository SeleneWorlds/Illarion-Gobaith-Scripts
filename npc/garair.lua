...
function M.initializeNpc()
    ...
    functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","No. I'm no trader. I'm the tax collector of Tol Vanima.");
    functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Nein ich bin kein Händler. Ich bin der Steuerneintreiber von Tol Vanima.");
    ...
    AllowedTaxCollectors[1750279883] = true; -- Isilwen
    AllowedTaxCollectors[1376856181] = true; -- Sideon Vilarion
