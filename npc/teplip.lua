--Name:        Teplip Efrullop
--Race:        Goblin
--Town:        Varshikar
--Function:    Travel Trader
--Position:    x=254 y=-297 z=0
--Facing:      South
--Last Update: 11/27/2005
--Update by:   Nitram

-- INSERT INTO npc VALUES (70, 8, 254, -297,0,4,'f','Teplip Efrullop','npc_teplip.lua',0);

require("npc.base.trader_functions")
require("npc.base.functions")
module("npc.teplip", package.seeall)
