...
thisNPC:increaseSkill(1,"common language",100);
    ...
    trader_functions.AddTraderItem(120 ,180 ,200 ,12 ,100 ,{5,7},{55,77},0   ,0   ); -- shirt
    trader_functions.AddTraderItem(140 ,183 ,200 ,14 ,100 ,{5,7},{55,77},0   ,0   ); -- trousers
    trader_functions.AddTraderItem(100 ,369 ,200 ,10 ,100 ,{5,7},{55,77},0   ,0   ); -- shoes
    trader_functions.AddTraderItem(10  ,191 ,500 ,1  ,100 ,{3}  ,{33},0   ,0      ); -- roll
    trader_functions.AddTraderItem(20  ,306 ,500 ,2  ,100 ,{3}  ,{33},0   ,0      ); -- ham
    trader_functions.AddTraderItem(100 ,353 ,200 ,8  ,100 ,{3}  ,{33},0   ,0       ); -- apple pie
    trader_functions.AddTraderItem(100 ,354 ,200 ,8  ,100 ,{3}  ,{33},0   ,0       ); -- strawberry cake
    trader_functions.AddTraderItem(100 ,303 ,200 ,8  ,100 ,{3}  ,{33},0   ,0       ); -- cherry cake
    trader_functions.AddTraderItem(20  ,49  ,200 ,2  ,100 ,{3}  ,{33},0   ,0       ); -- bread
    trader_functions.AddTraderItem(5   ,201 ,500 ,1  ,100 ,{3}  ,{33},0   ,0       ); -- onions
    trader_functions.AddTraderItem(5   ,2493,500 ,1  ,100 ,{3}  ,{33},0   ,0       ); -- cabbage

    TraderCopper=5000;

    functions.AddTraderTrigger("[Gg]reetings","Hi ho, friend! Do you need something?");
    functions.AddAdditionalTrigger("[Hh]ello");
    functions.AddAdditionalText("Good day! Is there something you need?");
    functions.AddTraderTrigger("I'm .+","Oh! A pleasure, friend.");
    functions.AddTraderTrigger("[Ww]ho.+you?","I'm "..thisNPC.name.." ! I live here in Greenbriar with the other halflings. Wouldn't want to live anywhere else at all!");
    functions.AddTraderTrigger("[Tt]ell.+[Ss]omething","If you ever go picking 'shrooms in the forest, be sure to look out for fireflies! I hear the tiny fairies ride on those.");
    functions.AddTraderTrigger("[Gg]oodbye","Buh-bye, friend! Come around Greenbriar again when you can.");
    ...
    functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Ich bin "..thisNPC.name.."! Ich leb hier in Greenbriar mit den anderen Halblingen. Und würd nicht um alles in der Welt hier weggehen!");
    functions.AddTraderTrigger("[Ee]rzähl.+[Ww]as","Wenn du jemals in den Wald gehst und Pilze sammelst, pass auf Leuchtkäfer auf. Ich hab gehört das Feen auf denen reiten.");
    ...
    functions.AddAdditionalText("Ich hoffe, du kommst mal wieder vorbei!");
    ...
    if functions.BasicNPCChecks(originator,2) then
        if (functions.LangOK(originator,TradSpeakLang)==true) then
            ...
            elseif (Status==8) then -- Einkaufspreis Ansage für ein Item // buying price announcement for an item
                gText=functions.GenusSel(Values[2],"Ein","Eine","Ein").." "..Tworld:getItemName(Values[2],0).." wäre mir"..trader_functions.MoneyText(0,Values[3],Values[4],Values[5],TraderLang).." wert.";
