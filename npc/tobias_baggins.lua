...
module("npc.tobias_baggins", package.seeall)
...
function lookAtNpc(Char, mode)
    if initLook==nil then
        output={};
        output[0]="Ein älterer Halbling mit dicker Brille, der in einem Buch ließt. Ein Stapel von weiteren Exemplaren dient ihm als Sitz.";
        output[1]="An elderly halfling with thick glasses who is reading a book. Some more books are forming a \"stool\" he is sitting on.";
        initLook=1;
    end
