...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(5   ,64  ,1000,1  ,1000,{5  },{77,90},0   ,0); -- arrow
    trader_functions.AddTraderItem(80  ,65  ,90  ,8  ,20  ,{5,6},{77,90},0   ,0); -- short bow
    trader_functions.AddTraderItem(120 ,2714,90  ,12 ,20  ,{5,6},{77,90},0   ,0); -- hunting bow
    trader_functions.AddTraderItem(150 ,2646,90  ,16 ,20  ,{5,6},{77,90},0   ,0); -- serinjah rider's bow
    trader_functions.AddTraderItem(500 ,2718,90  ,50 ,20  ,{5,6},{77,90},0   ,0); -- elven composite longbow
    trader_functions.AddTraderItem(200 ,2708,90  ,20 ,20  ,{5,6},{77,90},0   ,0); -- long bow
    trader_functions.AddTraderItem(100 ,90  ,90  ,10 ,20  ,{5,6},{77,90},0   ,0); -- flute
    trader_functions.AddTraderItem(400 ,335 ,90  ,40 ,20  ,{5,6},{77,90},0   ,0); -- lute
    trader_functions.AddTraderItem(500 ,332 ,90  ,50 ,20  ,{5,6},{77,90},0   ,0); -- harp
    trader_functions.AddTraderItem(200 ,2445,90  ,20 ,20  ,{5,6},{77,90},0   ,0); -- small wooden shield
    trader_functions.AddTraderItem(100 ,17  ,90  ,10 ,20  ,{5,6},{77,90},0   ,0); -- wooden shield
    trader_functions.AddTraderItem(200 ,2194,90  ,20 ,20  ,{5,6},{77,90},0   ,0); -- small hardwood greaves
    trader_functions.AddTraderItem(400 ,2193,90  ,40 ,20  ,{5,6},{77,90},0   ,0); -- hardwood greaves
    trader_functions.AddTraderItem(250 ,207 ,90  ,25 ,20  ,{5,6},{77,90},0   ,0); -- battle staff
    trader_functions.AddTraderItem(500 ,208 ,90  ,50 ,20  ,{5,6},{77,90},0   ,0); -- ornate mage's staff
    trader_functions.AddTraderItem(500 ,209 ,90  ,50 ,20  ,{5,6},{77,90},0   ,0); -- elven mage's staff

    TraderCopper=7000;

    functions.AddTraderTrigger("[Gg]reetings","The five with you. Can I help you?");
    functions.AddAdditionalTrigger("[Hh]ello");
    functions.AddAdditionalText("Be blessed, my friend. Do you need something?");
    functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","I am a trader, yes. I trade different carpentry tools.");
    functions.AddTraderTrigger("[Ww]hat.+sell","I sell all kinds of carpentry tools");
    functions.AddTraderTrigger("[Ww]hat.+[Tt]ools","I sell tools for carpenters. Saws, axes, planes and carving tools.");
    functions.AddTraderTrigger("[Tt]ell.+[Ss]omething","This is Tol Vanima, the home of us elves.");
    functions.AddTraderTrigger("[Gg]oodbye","The five with you!.");
    functions.AddAdditionalTrigger("[Bb]ye");
    functions.AddAdditionalText("May the gods bless your path!");
    functions.AddAdditionalTrigger("[Ff]arewell");
    functions.AddAdditionalText("Farewell, my friend!");
    functions.AddTraderTrigger("[Ww]hat.+buy","I buy all kinds of bows and crossbows.");
    functions.AddTraderTrigger("[Ww]ho.+you?","My name is "..thisNPC.name..".");
    functions.AddTraderTrigger("I'm .+","Be greeted!");
    ...
    functions.AddTraderTrigger("[Gg]r[üu][ßs]+","Die Fünf zum Gruße, kann ich euch helfen?");
    functions.AddAdditionalTrigger("[Hh]allo");
    functions.AddAdditionalText("Möge euer Pfad gesegnet sein! Wie kann ich euch helfen?");
    functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Ich bin ein Händler, ja, und ich verkaufe unter anderem Werkzeuge.");
    functions.AddTraderTrigger("[Ww]as.+verkauf","Ich verkaufe Werkzeuge für jede Art von Tischlerei.");
    functions.AddTraderTrigger("[Ww]as.+[Ww]erkzeug","Nun, ich verkaufe Tischlerwerkzeug...Sägen, Äxte, Hobel und Schnitzwerkzeuge.");
    functions.AddTraderTrigger("[Ee]rzähl.+[Ww]as","Dies ist Tol Vanima, die Heimat von uns Elfen.");
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Die Fünf seien mit euch. Bis bald!");
    functions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    functions.AddAdditionalText("Bis bald, mein Freund, der Segen der Fünf mit euch!");
    functions.AddTraderTrigger("[Ww]as.+%s[Kk]auf","Ich kaufe alle Arten von Bögen und Armbrüsten.");
    functions.AddTraderTrigger("[Ww]er.+[IiDd][hu]r*","Ich bin "..thisNPC.name..".");
    functions.AddTraderTrigger("Ich bin .+","So grüße ich euch, mein Freund!");
    ...
    functions.AddCycleText("#me schnitzt mit eleganten Bewegungen an einer kleinen Holzstatue herum","#me carves on a small wooden statue with a elegant motions");
    functions.AddCycleText("#me blickt sich kurz um","#me looks around a moment");
    functions.AddCycleText("#me betrachtet einen Pfeil prüfend","#me looks on an arrow with a checking glance");
    ...
    if functions.BasicNPCChecks(originator,2) then
        if (functions.LangOK(originator,TradSpeakLang)==true) then
			...
			elseif (Status==7) then -- Verkaufspreis Ansage für ein Item // selling price announcement for an item
                ...
                eText="The "..world:getItemName(Values[1],0).." costs"..trader_functions.MoneyText(1,Values[2],Values[3],Values[4],TraderLang)..".";
