...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(80  ,180 ,5 ,2  ,5 ,{5,7},{66,77},0   ,0       ); -- shirt
    trader_functions.AddTraderItem(50  ,183 ,5 ,2  ,5 ,{5,7},{66,77},0   ,0       ); -- trousers
    trader_functions.AddTraderItem(120 ,369 ,3 ,3  ,3 ,{5,7},{66,77},0   ,0       ); -- shoes
    trader_functions.AddTraderItem(250 ,55  ,5 ,3  ,5 ,{5,7},{66,77},0   ,0       ); -- cape
    trader_functions.AddTraderItem(200 ,48  ,5 ,4  ,5 ,{5,7},{66,77},0   ,0       ); -- gloves
    trader_functions.AddTraderItem(350 ,53  ,5 ,4  ,5 ,{5,7},{66,77},0   ,0       ); -- boots
    trader_functions.AddTraderItem(120 ,356 ,5 ,2  ,5 ,{5,7},{66,77},0   ,0       ); -- farmers hat
    trader_functions.AddTraderItem(25  ,9   ,3 ,0  ,3 ,{4,6},{77,90},0   ,0       ); -- saw
    trader_functions.AddTraderItem(25  ,126 ,4 ,0  ,4 ,{4,6},{77,90},0   ,0       ); -- sickle
    trader_functions.AddTraderItem(25  ,24  ,5 ,0  ,5 ,{4,6},{77,90},0   ,0       ); -- shovel
    trader_functions.AddTraderItem(40  ,2763,5 ,0  ,5 ,{4,6},{77,90},0   ,0       ); -- pickaxe
    trader_functions.AddTraderItem(25  ,23  ,3 ,0  ,3 ,{4,6},{77,90},0   ,0       ); -- hammer
    trader_functions.AddTraderItem(40  ,311 ,3 ,0  ,3 ,{4,6},{77,90},0   ,0       ); -- glass blow pipe
    trader_functions.AddTraderItem(25  ,74  ,3 ,0  ,3 ,{4,6},{77,90},0   ,0       ); -- axe

    TraderCopper=300;

    functions.AddTraderTrigger("[Gg]reetings","Indeed. Greetings. Who are you?");
    functions.AddAdditionalTrigger("[Hh]ello");
    functions.AddAdditionalText("Hello. How may I help you?");
    functions.AddTraderTrigger("[Hh]allo","Hallo. Kann ich euch vielleicht helfen?");
    functions.AddAdditionalTrigger("[Gg]r[uü][sß]+");
    functions.AddAdditionalText("In der Tat. Grüße. Wie geht es euch?");
    functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","Yes, I am a trader. What can I get you?");
    functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh][äa]ndler","Ja. Ich bin ein Händler. Kann ich etwas für euch besorgen?");
    functions.AddTraderTrigger("[Ww]hat.+sell","I sell clothes, tools and more.");
    functions.AddTraderTrigger("[Ww]as.+verkauf","Ich verkaufe Kleidung, Werkzeug und mehr.");
    functions.AddTraderTrigger("[Ww]hat.+[Cc]loth","I sell farmer hats, shirts, trousers, capes, gloves, shoes and boots and leatherarmor.");
    functions.AddTraderTrigger("[Ww]as.+[Kk]leidung","Ich verkaufe Schlapphüte, Hemden, Hosen, Umhänge, Handschuhe, Schuhe, Stiefel und Lederrüstungen.");
    functions.AddTraderTrigger("[Ww]hat.+[Tt]ool","I sell needles and scissors, saws, shovels, axes hammers and glass blowing pipes.");
    functions.AddTraderTrigger("[Ww]as.+[Ww]erkzeug","Ich verkaufe Nadeln und Scheren. Sägen und Schaufeln. Äxte und Hammer. Und Glasblasrohre.");
    functions.AddTraderTrigger("[Ww]hat.+[Mm]ore","I have some empty bottles for sale.");
    functions.AddTraderTrigger("[Ww]as.+[Mm]ehr","Ich habe einige leere Flaschen zum verkauf.");
    functions.AddTraderTrigger("[Bb]ye.","Aye. Good day to you");
    functions.AddAdditionalTrigger("[Ff]are.+well");
    functions.AddAdditionalText("Aye! Good day.");
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Bis bald!");
    functions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    functions.AddAdditionalText("Kommt doch noch einmal! Ich habe immer die besten Waren");
