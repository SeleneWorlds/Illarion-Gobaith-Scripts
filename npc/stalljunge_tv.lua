...
function M.initializeNpc()
    ...
    functions.AddTraderTrigger("[Hh]allo","Grüß dich!");
    ...
    functions.AddTraderTrigger("[Ff]arewell","Farewell. The Five with you");
    ...
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Auf Bald. Die Fünf mit euch!");
