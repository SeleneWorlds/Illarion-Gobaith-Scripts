...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(100 ,333 ,5  ,5  ,5  ,{6,8},{66,88},0   ,0       );    -- Horn
    trader_functions.AddTraderItem(100 ,2760,10 ,40 ,2  ,{6,8},{66,88},0   ,0       );    -- Rope/Seil
    trader_functions.AddTraderItem(40  ,58  ,15 ,0  ,15 ,{6,8},{66,88},0   ,0       );    -- Mortar/Mörser
    trader_functions.AddTraderItem(90  ,2586,15 ,5  , 5 ,{6,8},{66,88},0   ,0       );    -- Fur/Felle
    trader_functions.AddTraderItem(3   ,2588,300,0  ,300,{3,3},{33,33},0   ,0       );    -- Bricks/Ziegelsteine
    trader_functions.AddTraderItem(150 ,92  ,5 ,30  ,10 ,{6,7},{33,66},0   ,0       );    -- Oil lamp/Öllampe
    trader_functions.AddTraderItem(400 ,236 ,0 ,50  ,50 ,{6,7},{33,66},0   ,0       );    -- Gold ingots/Goldbarren
    trader_functions.AddTraderItem(400 ,1008 ,0 ,50 ,50 ,{6,7},{33,66},0   ,0       );    -- Copper kettle/Kupferkessel

    TraderCopper=5000;

    functions.AddTraderTrigger("[Hh]ello","Greetin's.");
    functions.AddAdditionalTrigger("[Gg]reetings");
    functions.AddAdditionalText("Aye! Greetins to ye'.");
    functions.AddTraderTrigger("[Hh]allo","Moin");
    functions.AddAdditionalTrigger("[Gg]rü[ßs]+e");
    functions.AddAdditionalText("Aye. Grüß euch.");
    functions.AddTraderTrigger("[Jj]ob","I'm an importer, and I pull in wares from far and wide. Puts the jingle in me purse.");
    functions.AddTraderTrigger("[Bb]eruf","Ich bin ein Importierer und bekomm Waren von weit, weit weg.");
    functions.AddTraderTrigger("[Ii]mported","Aye, imported wares, from the mainland to right here. See all the ships? Well, it's a quiet day today. Aye?");
    functions.AddTraderTrigger("[Ii]mportiert","Aye, importiere Waren, vom Festland direkt hier her. Siehst all die Schiffe. Nuja, ist ein ruhiger Tag heute, aye?");
    functions.AddTraderTrigger("[Ww]ares","I have all sorts of gimcracks that ye'll surely be interested in. You seen my list?");
    functions.AddTraderTrigger("[Ww]are","Ich hab alle Arten von Zeug die dich garantiert interessieren. Willst meine Warenliste sehen?");
    functions.AddTraderTrigger("[Ss]hip","Aye! I once sailed across the seas. Hard work. Not enough coin.");
    functions.AddTraderTrigger("[Ss]chiff","Aye! Bin lange zur See gefahren. Harte Arbeit und beschissene Bezahlung.");
    functions.AddTraderTrigger("[Bb]ye","Aye! Farewell there.");
    functions.AddAdditionalTrigger("[Ff]arewell");
    functions.AddAdditionalText("'Ave a pleasant day, there!");
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Aye. Auf bald.");
    functions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    functions.AddAdditionalText("Aye. Schön Tag noch.");
