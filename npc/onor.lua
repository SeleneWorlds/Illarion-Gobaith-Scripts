...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(100   ,3077 ,4294967295 ,0   ,4294967295 ,{3,3} ,{33,33} ,0    ,0);      -- Silbermünzen
    trader_functions.AddTraderItem(10000 ,61   ,4294967295 ,0   ,4294967295 ,{3,3} ,{33,33} ,0    ,0);      -- Goldmünzen

    TraderCopper=0;

    functions.AddTraderTrigger("[Gg]reet","Greetings. What can I do for you?");
    functions.AddAdditionalTrigger("[Hh]ello");
    functions.AddAdditionalText("Greetings. You are interested in money?");
    functions.AddTraderTrigger("[Ww]hat.+sell","I exchange coins.");
    functions.AddTraderTrigger("[Bb]ye","Good day. Safe travels.");
    functions.AddAdditionalTrigger("[Ff]arewell");
    functions.AddAdditionalTrigger("[Bb]e [Ww]ell");
    functions.AddAdditionalText("Farewell. You are always welcome.");
    functions.AddTraderTrigger("[hH]elp","'List your wares', 'I want to buy <number> <wares>', 'I want to buy a <ware>', 'Price of ...'");
    functions.AddTraderTrigger("[Gg]rü[ßs]+e","Grüße. Was kann ich für Euch tun?");
    functions.AddAdditionalTrigger("[Hh]allo");
    functions.AddAdditionalText("Grüße. Habt ihr Interesse an Geld?");
    functions.AddTraderTrigger("[Aa]uf [Bb]ald","Auf bald. Eine sichere Reise.");
    functions.AddAdditionalTrigger("[Bb]is [Bb]als");
    functions.AddAdditionalTrigger("[Mm]achs [Gg]ut");
    functions.AddAdditionalText("Bis bald. Ihr seid immer willkommen.");
    functions.AddTraderTrigger("[Hh]ilfe","'Welche Waren verkauft ihr', 'Ich möchte <Anzahl> <Ware> kaufen', 'Ich möchte <Ware> kaufen', 'Was ist der Preis von <Ware>'");

    functions.AddCycleText("#me schnippst ein Kupferstück in die Luft","#me flips a copper coin into the air");
    functions.AddCycleText("#me schnippst ein Silberstück in die Luft","#me flips a silver coin into the air");
    functions.AddCycleText("#me schnippst ein Goldstück in die Luft","#me flips a gold coin into the air");
