...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(20  ,49  ,500 ,3  ,300 ,{3}  ,{33}   ,0   ,0       ); -- bread
    trader_functions.AddTraderItem(0   ,191 ,500 ,1  ,300 ,{3}  ,{33}   ,0   ,0       ); -- roll
    trader_functions.AddTraderItem(10  ,306 ,500 ,2  ,300 ,{3}  ,{33}   ,0   ,0       ); -- ham
    trader_functions.AddTraderItem(10  ,73  ,500 ,1  ,300 ,{3}  ,{33}   ,0   ,0       ); -- fish
    trader_functions.AddTraderItem(15  ,355 ,500 ,1  ,300 ,{3}  ,{33}   ,0   ,0       ); -- trout
    trader_functions.AddTraderItem(40  ,258 ,60  ,0  ,60  ,{5}  ,{88}   ,0   ,0       ); -- flail
    trader_functions.AddTraderItem(40  ,271 ,70  ,0  ,70  ,{5}  ,{88}   ,0   ,0       ); -- scythe
    trader_functions.AddTraderItem(40  ,126 ,30  ,0  ,30  ,{5}  ,{88}   ,0   ,0       ); -- sickle
    trader_functions.AddTraderItem(40  ,72  ,50  ,0  ,50  ,{5}  ,{88}   ,0   ,0       ); -- fishing rod
    trader_functions.AddTraderItem(3   ,259 ,100 ,0  ,500 ,{3}  ,{33}   ,0   ,0       ); -- grain
    trader_functions.AddTraderItem(3   ,534 ,100 ,0  ,500 ,{3}  ,{33}   ,0   ,0       ); -- onion seeds
    trader_functions.AddItemTrigger("onion");
    trader_functions.AddItemTrigger("zwiebel");
    trader_functions.AddTraderItem(3   ,291 ,100 ,0  ,500 ,{3}  ,{33}   ,0   ,0       ); -- cabbage
    trader_functions.AddItemTrigger("cabbage");
    trader_functions.AddItemTrigger("Kohl");

    functions.AddTraderTrigger("[Gg]reet","Hiho. Who are you?");
    functions.AddAdditionalTrigger("[Hh]ello");
    functions.AddAdditionalTrigger("[Hh]i");
    functions.AddAdditionalText("Hiho. How i can help you?");
    functions.AddTraderTrigger("[Hh]allo","Hiho! Wer bist du?");
    functions.AddAdditionalTrigger("[Gg]r[uü][sß]*");
    functions.AddAdditionalText("Hiho! Wie kann ich dir helfen?");
    functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","Yes, I am a trader. What do you want?");
    functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]ändler","Jap, ich bin Händler. Was brauchst du?");
    functions.AddTraderTrigger("[Ww]hat.+sell","I sell tools, food and seeds.");
    functions.AddTraderTrigger("[Ww]as.+verkauf","Ich verkauf' Werkzeug, Nahrung und Samen.");
    functions.AddTraderTrigger("[Ww]hat.+[Ff]ood","I sell bread and ham. Fish and trout.");
    functions.AddTraderTrigger("[Ww]as.+[Nn]ahrung","Ich verkauf' Brot und Schinken. Fische und Forellen");
    functions.AddTraderTrigger("[Ww]hat.+[Ss]eed","I sell grain and cabbage seeds.");
    functions.AddTraderTrigger("[Ww]as.+[Ss]amen","Ich verkauf' Getreide und Kohlsamen");
    functions.AddTraderTrigger("[Ww]hat.+[Tt]ool","I have flails, scythe, sickles, fishing rod.");
    functions.AddTraderTrigger("[Ww]as.+[Ww]erkzeug","Ich habe Dreschflegel, Sensen, Sicheln und Angeln. Interessiert?");
    functions.AddTraderTrigger("[Gg]oodbye","Have a good day. You are welcomed to come back.");
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Schönen Tag noch! Bis bald!");
    functions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    functions.AddAdditionalText("Bis Bald! Ushara mit dir!");
    functions.AddTraderTrigger("[Bb]ye","Farewell.");
    functions.AddAdditionalTrigger("[Ff]arewell");
    functions.AddAdditionalText("Farewell. Ushara may be with you.");
    functions.AddTraderTrigger("[Ww]ho.+you?","I am "..thisNPC.name..", a farmer.");
    functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Ich bin "..thisNPC.name..", Bauer.");
