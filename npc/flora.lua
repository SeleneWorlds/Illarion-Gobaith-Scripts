...
-- Queststatus = 10 (COMPLETED) - Person named
    npc.base.autonpcfunctions.AddTraderTrigger("hello","Hello again, sir %CHARNAME, it is always nice seeing you.");
    npc.base.autonpcfunctions.AddCondition("state","=",1);
    npc.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
    npc.base.autonpcfunctions.AddCondition("sex","male");
    npc.base.autonpcfunctions.AddTraderTrigger("greet","Ah, sir %CHARNAME, a pleasure seeing you again.");
    npc.base.autonpcfunctions.AddCondition("state","=",1);
    npc.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
    npc.base.autonpcfunctions.AddCondition("sex","male");
    ...
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
    npc.base.autonpcfunctions.AddCondition("sex","male");
    npc.base.autonpcfunctions.AddTraderTrigger("hello","Hello %CHARNAME, it is always nice seeing you.");
    npc.base.autonpcfunctions.AddCondition("state","=",2);
    npc.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
    npc.base.autonpcfunctions.AddCondition("sex","male");
    npc.base.autonpcfunctions.AddTraderTrigger("greet","%CHARNAME, a pleasure seeing you again.");
    npc.base.autonpcfunctions.AddCondition("state","=",2);
    npc.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
    npc.base.autonpcfunctions.AddCondition("sex","male");
...
-- Queststatus = 10 (COMPLETED)
    ...
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
    npc.base.autonpcfunctions.AddTraderTrigger("why","My mother used to tell me stories about this wonderful flower. But now she passed out, and I have no memories of her. The flower can serve as one.");
...
-- Queststatus = 4
    ...
    npc.base.autonpcfunctions.AddTraderTrigger("I got flower","What? You have the Night Angels Blossom?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",4);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I have it","You mean, the Night Angels Blossom? You have it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",4);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I got it","You mean, the Night Angels Blossom? You have it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",4);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I have night angels blossom","What? You have the flower with you?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",4);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I got night angels blossom","What? You have got the flower with you?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",4);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
...
-- Queststatus = 5
    ...
    npc.base.autonpcfunctions.AddCondition("qpg","=",5);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I got flower","What? You have the Night Angels Blossom? Can you give it to me?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",5);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I have it","You mean, the Night Angels Blossom? You have it? May I take it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",5);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I got it","You mean, the Night Angels Blossom? You have it? May I take it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",5);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I have night angel blossom","Oh you have it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I brought night angel blossom","You brought the flower? May I look at it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
...
-- Queststatus = 6
    ...
    npc.base.autonpcfunctions.AddCondition("qpg","=",6);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I got flower","What? You have the Night Angels Blossom? Can you give it to me please?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",6);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I brought flower","You brought the flower? Really? Can I take it please?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",6);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I have night angel blossom","You have the flower with you? Can I see it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I brought night angel blossom","You brought the flower? May I look at it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
...
-- Queststatus = 7
    ...
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I got flower","#me blinks and lifts her eyebrows, 'What? You have the flower? Can I see it?'");
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    ...
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I have night angel blossom","Hm? You've brought the flower? Really? May I see it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
    npc.base.autonpcfunctions.AddTraderTrigger("I brought night angel blossom","What? You brought the flower? Can I see it?");
    npc.base.autonpcfunctions.AddCondition("qpg","=",7);
    npc.base.autonpcfunctions.AddConsequence("qpg","=",8);
...
-- INTRODUCTION PHRASES
    ...
    npc.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npc.base.autonpcfunctions.AddCondition("sex","male");
    npc.base.autonpcfunctions.AddTraderTrigger("call sir","#me blushes a bit, then says, 'Apologies. I'll just say %CHARNAME then.'");
    npc.base.autonpcfunctions.AddCondition("state","<>",2);
    npc.base.autonpcfunctions.AddConsequence("state",2);
    npc.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npc.base.autonpcfunctions.AddCondition("sex","male");
    ...
    npc.base.autonpcfunctions.AddCondition("race",CCharacter.elf);
    npc.base.autonpcfunctions.AddCondition("sex","male");
    npc.base.autonpcfunctions.AddTraderTrigger("call sir","#me blushes a bit, then says, 'I aplogize. I'll just say %CHARNAME then.'");
    npc.base.autonpcfunctions.AddCondition("state","<>",2);
    npc.base.autonpcfunctions.AddConsequence("state",2);
    npc.base.autonpcfunctions.AddCondition("race",CCharacter.human);
    npc.base.autonpcfunctions.AddCondition("sex","male");
...
-- JOB after quest completed
    npc.base.autonpcfunctions.AddTraderTrigger("your job","I have basic abilities in druidry. If you are injured, please come to me.");
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
    npc.base.autonpcfunctions.AddTraderTrigger("what do you","I'm a competent druid. Should you be injured, come to me.");
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
    npc.base.autonpcfunctions.AddTraderTrigger("what you doing","Observing the beauty of the flowers.");
    npc.base.autonpcfunctions.AddCondition("qpg","=",10);
...
-- DEBUGGING
    npc.base.autonpcfunctions.AddTraderTrigger("reset me","I will reset you");
...
function receiveText(texttype, message, originator)
    if npc.base.autonpcfunctions.BasicNPCChecks(originator,2) then
        if npc.base.autonpcfunctions.LangOK(originator,TradSpeakLang) then
            ...
            npc.base.autonpcfunctions.TellSmallTalk(debugText..message,originator);
        else
