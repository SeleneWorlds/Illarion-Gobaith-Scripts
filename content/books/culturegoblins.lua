...
function M.loadBook(toData)
    ...
    base.books.AddGermanBookText("Wir, die Goblins, stehen in einer gewissen Beziehung zu Orks, glaube ich. Sicher, wir sind flinker und gewitzter. Wir haben gro�e Augen, Ohren und M�nder. Unser ganzer K�rper ist mit einem Kurzhaarfell bedeckt.",0,0,toData);
    base.books.AddGermanBookText("Unser Gesicht weist eine gr�ne lederartige Haut auf. Man sagt auch, wir bes��en eine Fistelstimme. Ich wurde mal mit einem S�ugling verglichen, der heult, weil er seinen Schnuller verloren hat. Was soll's.",0,0,toData);
    base.books.AddGermanBookText("Wir sind etwas klein und nicht gerade sehr stark und leben in lockeren Familienbanden, deren F�hrung sich untereinander stark unterscheidet. Wir sind nicht b�se, nein, aber auch nicht auf den Kopf gefallen und wir m�gen keine langweiligen Religionen.",0,0,toData);
    base.books.AddGermanBookText("Man sagt, ich w�rde mich schrecklich kleiden und manchmal auch muffeln, aber das glaube ich nicht. Auch dass meine Essmanieren schlecht w�ren, sagt man, und das was ich esse sei nicht schmackhaft - also ich finde es k�stlich.",0,0,toData);
    base.books.AddGermanBookText("Offenbar ist ein gut gereifter rostiger Dolch keine Nahrung f�r Menschen, aber deshalb sollten sie so etwas trotzdem mal kosten.",0,0,toData);
    base.books.AddGermanBookText("Bisweilen werden wir eingefangen und von Ork-Horden versklavt, deshalb versuchen wir, ihnen aus dem Weg zu gehen. Wir erschrecken uns leicht, nat�rlich nicht vor Halblingen, die sind ja auch gar nicht schrecklich. Nicht so wie diese riesigen Elben.",0,0,toData);
    base.books.AddGermanBookText("Geruch und Geschmack sind bei uns stark ausgepr�gt, und wir sind sehr geschickt mit den H�nden. Wir geben gute Alchemisten ab oder Handwerker, sogar Diebe. Aber ich bin nat�rlich keiner, das schw�re ich.",0,0,toData);
    base.books.AddGermanBookText("Wir m�gen keine Magie, aber einige von uns haben wohl Talent dazu. Ich habe von diesem weisen <highlor-angurian> zauberer geh�rt. Wer wei�, vielleicht nur ein Ger�cht!",0,0,toData);
    base.books.AddGermanBookText("Wir leben nicht in D�rfern, sondern in kleinen Lagern. Manche Leute finden solche Lager bedrohlich, ich verstehe gar nicht, warum. Auf jemanden mit einer Schleuder einen Stein zu werfen, ist doch nicht wirklich schlimm!",0,0,toData);
