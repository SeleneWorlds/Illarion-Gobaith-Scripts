...
function M.loadBook(toData)
    base_books.AddLanguage("halfling language",toData); 
    
    base_books.AddEnglishBookText("About the Humans from Thomas Berryard",2862,15,toData); -- ### Human ### scarecrow instead of human
    base_books.AddEnglishBookText("On all of my adventures through the wild scenery Salkamar, i have seen a lot of humans and even had the chance to get to know some of them. Because they are living there.",0,15,toData); 
    base_books.AddEnglishBookText("When someone is asking me now, Thomas Berryard how are those humans? Then i have to tell many stories. Some are funny and some might appear weird. But that's the way those humans are.",0,15,toData); 
    base_books.AddEnglishBookText("First of all they are way too tall, and that is what you will recognize immediately when seeing them. Almost as twice as tall as the tallest fellow of your kin. They are like trees.",0,15,toData); 
    base_books.AddEnglishBookText("They creak and crackle when they move and they are generally quite awkward and clumsy. But that is quite understandable because with such long legs it is surely difficult to walk. It surely is",0,15,toData); 
    base_books.AddEnglishBookText("difficult for the head to tell the feet what they shall do since they are far apart from each other. Another reason might be, that the tall ones are enclosing their feet, like the dwarves. They are",0,15,toData); 
    base_books.AddEnglishBookText("doing it because their feet are really doesn't look well and they are scared that we laugh at them. I have seen one, a human foot and i can tell that it didn't have hair and it was smooth and",0,15,toData); 
    base_books.AddEnglishBookText("slick like a fish.",0,15,toData); 
    base_books.AddEnglishBookText("But what i really have to say is that a lot of the humans have their heart on the right spot. They may be clumsy but they do care about their children with love and care.",0,15,toData); 
    base_books.AddEnglishBookText("And since their children are as tall as we are, what really appears a little strange when they talk with you, then it can happen that they doesn't understand that you are an halfling is, at first.",0,15,toData); 
    base_books.AddEnglishBookText("Generally, their big heads appear as if they have a lot more free space for mischief. When they doesn't have no more space in their city then they just build a second house on top of the house which",0,15,toData); 
    base_books.AddEnglishBookText("is already built on the ground. Then it looks as if it would crash in the next moment. I was too afraid to go inside. Then they have a king. They pick the king when he is still drinking milk from his",0,15,toData); 
    base_books.AddEnglishBookText("mother or so, and he is allowed to say what the humans are allowed to do and what not. The things he says which are forbidden are not allowed to do then. They sometimes try to school you because they",0,15,toData); 
    base_books.AddEnglishBookText("are thinking we are children. They try to persuade you of their big-head nonsense and give you advices of which you didn't even ask for. Best to get along with them then is to just say yes to all the",0,15,toData); 
    base_books.AddEnglishBookText("things they try to persuade you, but you definitely won't do what they want you to do. When you try to discuss a matter then they just give you more advices.",0,15,toData); 
    base_books.AddEnglishBookText("Some humans become fidgety when it's calm and cosy. Then they go and cause troubles and even more. In the big cities it is never quiet and there is always riot.",0,15,toData); 
