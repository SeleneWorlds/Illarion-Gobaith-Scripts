...
function M.loadBook(toData)
    ...
    base.books.AddGermanBookText("Lange, wei�e, wollene F�den werden bevorzugt um einen feinen, starken Stoff zu weben, der wesentlich besser gef�rbt werden kann.",178,5,toData);
    base.books.AddGermanBookText("Gewaltsam jemanden den Hut wegzunehmen wird als eine gro�e Beleidigung angesehen, besonders von Frauen.",357,20,toData);
    ...
    base.books.AddGermanBookText("Die Wolle, die sich die meisten leisten k�nnen, ist blau und gr�n und wird von der Mittelklasse getragen.",2679,80,toData);
    base.books.AddGermanBookText("Ein guter Schneider misst jeden Kunden aus und macht gew�hnlich alle Art von Kleidung.",0,100,toData);
