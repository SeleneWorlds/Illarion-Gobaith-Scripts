...
function M.InitCustomLookAt()
	...
	addDescription(	235,	2,	"mit der Gravur 'König der Ringer'", "with the gravure 'Wrestler King'", false, false, false );
	addDescription(	235,	3,	"mit der Gravur 'König der Schmiede'", "with the gravure 'Smith King'", false, false, false );
	addDescription(	235,	4,	"mit der Gravur 'König der Schreiner'", "with the gravure 'Carpenter King'", false, false, false );
	addDescription(	235,	5,	"mit der Gravur 'König der Schneider'", "with the gravure 'Tailor King'", false, false, false );
	addDescription(	235,	6,	"mit der Gravur 'König der Läufer'", "with the gravure 'Runner King'", false, false, false );
	addDescription(	235,	7,	"mit der Gravur 'König der Bergleute'", "with the gravure 'Miner King'", false, false, false );
	addDescription(	235,	8,	"mit der Gravur 'König der Dichter'", "with the gravure 'Poet King'", false, false, false );
	addDescription(	235,	9,	"mit der Gravur 'König der Barden'", "with the gravure 'Bard King'", false, false, false );
	addDescription(	235,	10,	"mit der Gravur 'König der Krieger'", "with the gravure 'Warrior King'", false, false, false );
	...
	addDescription(2547,	1,	"weißes Stück Leder mit einem gr�nen Band und dem Zeichen der Nordmark eingebrandt", "white piece of leather with a green ribbon and the emblem of the Nordmark burnt in", true, true, false );
	...
	addDescription(2547,	7,	"weißes Stück Leder mit einem gr�n blauen Band und dem Zeichen der Nordmark eingebrandt", "white piece of leather with a green blue ribbon and the emblem of the Nordmark burnt in", true, true, false );
