...
local SUFFIX_EN = {"","","","","","",""};
	...
	if (Class==1 or Class==2) then
		...
		if Str==5 then -- Sufe 6
			-- Edelstein
			SUFFIX_DE={"der Haltbarkeit","der Sorgfalt","des Sch�lers","des Barbaren","der Abwehr","des Hasen","der Raubkatze"}
		...
		elseif Str==6 then -- Sufe 7
            SUFFIX_DE={"der Belastbarkeit","der Treffsicherheit","des Adepten","des Schl�chters","der Parade","der Katze","des Wolfes"}
		...
		elseif Str==7 then -- Sufe 8
			SUFFIX_DE={"der Stabilit�t","der Zielsicherheit","des K�nners","der Bestie","der Gewandheit","des Panthers","des L�wen"}
            SUFFIX_EN={"of stability","of aim","of the expert","of the beast","of agility","of the panther","of the lion"}
		elseif Str==8 then -- Sufe 9
			SUFFIX_DE={"der Langlebigkeit","der Pr�zision","des Lehrmeisters","des D�mons","der Verteidigung","des Geparden","des Ogers"}
		...
		elseif Str==9 then -- Sufe 10
			SUFFIX_DE={"der Unzerst�rbarkeit","der Genauigkeit","des Gro�meisters","des Todes","der Unantastbarkeit","des Greifs","des Drachen"}
            SUFFIX_EN={"of endurance","of precision","of the weapons master","of the undead","of defense","of the griffin","of the dragon"}
		end
	-- ** Suffix f�r die R�stung / Schilde **
	elseif (Class==3 or Class==4) then
		-- St�rke
		if Str==5 then -- Sufe 6
            -- Edelstein
            SUFFIX_DE={"der Haltbarkeit","der Stechm�cke","des Schafes","der Dornen","der Abwehr","des Hasen","der K�fer"}
        ...
        elseif Str==7 then -- Sufe 8
            SUFFIX_DE={"der Stabilit�t","der Wespe","der Mumie","des Faulwurms","der Gewandheit","des Panthers","der Schildkr�te"}
        ...
        elseif Str==9 then -- Sufe 10
            SUFFIX_DE={"der Unzerst�rbarkeit","der Tarantel","des B�ren","der Qual","der Unantastbarkeit","des Greifen","des Gargoyles."}
            SUFFIX_EN={"of endurance","of the tarantula","of a bear","of agony","of inviolability","of a griffin","of the gargoyle"}
        end
	-- **Suffix f�r Zauberst�be **
    elseif Class==5 then
        -- St�rke
        if Str==5 then -- Sufe 6
            -- Edelstein
        ...
        elseif Str==7 then -- Sufe 8
            SUFFIX_DE={"der Stabilit�t","der Weite","der Zerst�rung","der �berlieferung","der Erhaltung","des Panthers","des Manas"}
        ...
        elseif Str==9 then -- Sufe 10
            SUFFIX_DE={"der Unzerst�rbarkeit","des Horizontes","der Apokalypse","des geheimen Wissens","der Sch�pfung","des Greifen","der Regeneration"}
            SUFFIX_EN={"of endurance","of horizon","of the apocalypse","of arcane wisdom","of creation","of the griffin","of regeneration"}
        end
	-- ** Suffix f�r Werkzeuge **
	elseif Class==6 then
        -- St�rke
        if Str==5 then -- Sufe 6
            -- Edelstein
            SUFFIX_DE={"der Haltbarkeit","der Verz�gerung","des Sch�lers","der Sanierung","der Feinheit","des Hasen","der gelungenen Form"}
        ...
        elseif Str==7 then -- Sufe 8
            SUFFIX_DE={"der Stabilit�t","der Best�ndigkeit","des Gesellen","der Instandsetzung","der Meisterschaft","des Panthers","des Gesellenst�cks"}
            SUFFIX_EN={"of stability","of durability","of expert","of repairs","of craft ","of the panther","of worth"}
        elseif Str==8 then -- Sufe 9
            SUFFIX_DE={"der Langlebigkeit","der Permanenz","des Meisters","der Reparatur","der Makellosigkeit","des Geparden","des Meisterst�cks"}
            SUFFIX_EN={"of longevity","of permanence","of the master","of mender","of craftsmanship","of the cheetah","of masterwork"}
        elseif Str==9 then -- Sufe 10
            SUFFIX_DE={"der Unzerst�rbarkeit","der Ewigkeit","der Gildenmeisters","der Wiederherstellung","der Perfektion","des Greifen","des Kunstwerks"}
	...
	elseif Class==7 then
        ...
        if Str==0 then
            -- Edelstein
            SUFFIX_DE={"der Ideen","des Tr�ffelschweins","der ruhigen Hand","der Ameise","des Wohlbefindens","des Seepferdchens","des Novizen"}
            SUFFIX_EN={"of ideas","of the forager","of even hand","of the ant","of wellness","of seehorse","of novice"}
		elseif Str==1 then
            SUFFIX_DE={"des Geistesblitzes","des Adlers","des Eichh�rnchens","des Lasttiers","des G�rteltiers","der Schnelligkeit","der Konzentration"}
		...
		elseif Str==2 then
            SUFFIX_DE={"der Eule","der Weitsicht","des Taschenspielers","des Stieres","der Schildkr�te","der Gewandheit","des reinen Geistes"}
            SUFFIX_EN={"of the owl","of skills","of the conjuror","of the bull","of the turtle","of agility","of pure mind"}
		elseif Str==3 then
            SUFFIX_DE={"der Erkenntnis","der gesch�rften Sinne","der flinken Finger","der Muskelmasse","der Resistenz","der Schlange","des Magiers"}
            SUFFIX_EN={"of knowledge","of honed senses","of agile fingers","of muscles","of resistance","of the snake","of skill"}
		elseif Str==4 then
            SUFFIX_DE={"der Geistessch�rfe","der Wahrnehmung","des Frettchens","der Gewalt","des Schutzes","des Wiesels","der strahlenden Aura"}
		...
		elseif Str==5 then -- Sufe 6
            SUFFIX_DE={"der Hirschkuh","der Aufmerksamkeit","des Kraken","der St�rke","des Widerstandes","der Gazelle","des Schamanen"}
            SUFFIX_EN={"of the hind","of alertness","of the octopus","of the ant","resistance","of the gazelle","of the shaman"}
        elseif Str==6 then -- Sufe 7
            SUFFIX_DE={"der Klugheit","der Wachsamkeit","der Fingerfertigkeit","des Riesen","der Konstitution","des flinken Fu�es","des Hochmagiers"}
            SUFFIX_EN={"of wisdom","of the watchful eye","of dexterity","of strength","of constitution","of agile feet","of the high mage"}
        elseif Str==7 then -- Sufe 8
            SUFFIX_DE={"der Intelligenz","der Entdeckung","der Geschicklichkeit","der Kraft","der Gesundheit","der Leichtigkeit","des Beschw�rung"}
            SUFFIX_EN={"of intelligence","of detection","of fortune","of force","of health","of ease","of incantation"}
        elseif Str==8 then -- Sufe 9
            SUFFIX_DE={"der Weisheit","der Voraussicht","des Fuchses","der Giganten","des Ph�nix","der Raserei","des Erzmagiers"}
	...
	if Str<=4 then
        ...
        SUFFIX_EN={"adorned with a diamond","adorned with an emerald","adorned with a ruby","adorned with a blackstone","adorned with a bluestone","adorned with an amethyst","adorned with a topas"}
	end
...
-- Gibt den Pr�fix f�r das Item zur�ck
--
-- @param: CharacterStruct - Der Char, der sich das Item ansieht
-- @param: integer - ClassID des betrachteten Items
...
local PRAEFIX_EN = {"","","","","","",""};
    ...
    if (Class==1 or Class==2) then
        ...
        elseif Str==6 then -- Sufe 7
            PRAEFIX_DE={"robuste","zielsichere","durchschlagende","brutale","sch�tzende","flotte","gl�nzende"}
            PRAEFIX_EN={"robust","steady","striking power","gory","protective","brisk","bite"}
        elseif Str==7 then -- Sufe 8
            PRAEFIX_DE={"stabile","genaue","zertr�mmernde","blutr�nstige","vereitelnde","schnelle","geschmeidige"}
            PRAEFIX_EN={"stable","clear","destructive","brutal","impeding","fast","lithe"}
        elseif Str==8 then -- Sufe 9
            PRAEFIX_DE={"unverw�stliche","pr�zise","pulverisierende","grausame","b�ndigende","gewandte","gesch�rfte"}
            PRAEFIX_EN={"durable","precise","dangerous","gruesome","elusive","agile","edge"}
        elseif Str==9 then -- Sufe 10
            PRAEFIX_DE={"unzerst�rbare","exakte","heldenhafte","lethale","defensive","rasende","t�dliche"}
    ...
    elseif (Class==3 or Class==4) then
        ...
        if Str==5 then -- Sufe 6
            -- Edelstein
			PRAEFIX_DE={"solide","stoffverst�rkte","abschw�chende","dornenbesetzte","gediegene","weiche","lederverst�rkte"}
            PRAEFIX_EN={"solid","fabric fortified","alleviative","thorned","solid","soft","leather fortified"}
        elseif Str==6 then -- Sufe 7
            PRAEFIX_DE={"robuste","holzverst�rkte","d�mpfende","stachelige","verst�rkte","geweitete","knochenverst�rkte"}
            PRAEFIX_EN={"robust","wood fortified","cushioning","stinger","reinforced","widened","bone reinforced"}
        elseif Str==7 then -- Sufe 8
            PRAEFIX_DE={"stabile","blechverst�rkte","abfedernde","zahnbewehrte","verbesserte","ge�lte","hornverst�rkte"}
            PRAEFIX_EN={"stable","iron sheet fortified","padding","teethed","enhanced","oiled","shell reinforced"}
        elseif Str==8 then -- Sufe 9
            PRAEFIX_DE={"unverw�stliche","eisenverst�rkte","wattierte","schmerzbringende","geh�rtete","gewandte","chitinverst�rkte"}
            PRAEFIX_EN={"unbreakable","iron fortified","padded","ache bringing","hardened","cunning","chitin fortified"}
        elseif Str==9 then -- Sufe 10
            PRAEFIX_DE={"unzerst�rbare","stahlverst�rkte","gepolsterte","qu�lende","gepanzerte","befreiende","schuppenverst�rkte"}
            PRAEFIX_EN={"indestructible","steel fortfied","bolstered","excruciating","ironclad","freeing","scale reinforced"}
		end
	-- ** Praefix f�r Zauberst�be **
    elseif Class==5 then
        -- St�rke
        if Str==5 then -- Sufe 6
            -- Edelstein
            PRAEFIX_DE={"solide","weitende","k�mpfende","funkelnde","formende","flinke","spirituelle"}
            PRAEFIX_EN={"solid","widening","fighting","scintillating","formidable","nimble","spiritual"}
        elseif Str==6 then -- Sufe 7
            PRAEFIX_DE={"robuste","erweiterte","vergeltende","gl�nzende","heilende","flotte","energetische"}
            PRAEFIX_EN={"robust","extended","retaliatory","brilliant","healing","brisk","energetic"}
        elseif Str==7 then -- Sufe 8
            PRAEFIX_DE={"stabile","verbesserte","zerst�rende","gl�hende","gestaltende","schnelle","kraftvolle"}
            PRAEFIX_EN={"stable","enhanced","destroying","glowing","forging","quick ","powerful"}
        elseif Str==8 then -- Sufe 9
            PRAEFIX_DE={"unverw�stliche","ausdehnende","vernichtende","strahlende","bewahrende","gewandte","erneuernde"}
            PRAEFIX_EN={"unbreakable","expansive","devastating","radiating","conserving","agile","quick"}
        elseif Str==9 then -- Sufe 10
            PRAEFIX_DE={"unzerst�rbare","weitreichende","apokalyptische","magische","erschaffende","rasende","regenerierende"}
            PRAEFIX_EN={"indestructible","far-reaching","apocalyptic","magic","creative","wild","regenerating"}
        end
	-- ** Praefix f�r Werkzeuge **
	elseif Class==6 then
        -- St�rke
        if Str==5 then -- Sufe 6
            -- Edelstein
            PRAEFIX_DE={"solide","verz�gernde","brauchbare","ausbessernde","gute","rasende","wohlgeformte"}
            PRAEFIX_EN={"solid","delayed","viable","renovating","good","nimble","well formed"}
        elseif Str==6 then -- Sufe 7
            PRAEFIX_DE={"robuste","lebensverl�ngernde","ge�bte","restaurierende","verbesserte","gewandte","verbessernde"}
            PRAEFIX_EN={"robust","life prolonging","trained","refurbishing","enhanced","brisk","enhancing"}
        elseif Str==7 then -- Sufe 8
            PRAEFIX_DE={"stabile","best�ndige","geschickte","instandsetzende","hervorragende","schnelle","au�ergew�hnliche"}
            PRAEFIX_EN={"stable","constant","skilled","repairing","outstanding","quick","exceptional"}
        elseif Str==8 then -- Sufe 9
            PRAEFIX_DE={"unverw�stliche","langlebige","fachm�nnische","reparierende","gro�artiges","flotte","herausragende"}
            PRAEFIX_EN={"unbreakable","durable","skilled","repairing","flawless","agile","prominent"}
        elseif Str==9 then -- Sufe 10
            PRAEFIX_DE={"unzerst�rende","immerw�hrende","perfekte","wiederherstellende","meisterliche","flinke","formvollendete"}
	...
	if Str<=4 then
        ...
        PRAEFIX_EN={"diamond ornated","emerald ornated","ruby ornated","blackstone ornated","bluestone ornated","amethyst ornated","topas ornated"}
    end
...
-- Gibt den String der betreffenden Itemklasse zur�ck
--
-- @param: CharacterStruct - Der Char, der sich das Item ansieht
...
-- Gibt den String des "eingesetzten Steins" zur�ck
--
-- @param: CharacterStruct - Der Char, der sich das Item ansieht
...
-- Gibt den String der St�rke des "eingesetzten Steins" zur�ck
--
-- @param: CharacterStruct - Der Char, der sich das Item ansieht
