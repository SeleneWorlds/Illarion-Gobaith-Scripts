...
M.Script = "m_08_16_22_create-meat.lua";
...
M.Settings = {
    ["Runes"] = "ORL KAH QWAN",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
    ["Range"] = 0,          -- Maximum distance in tiles between the target of the spell and the caster
...
M.SpellEffects = {
    ...
    [0] = {                 -- Radius 0 around the target location (so this IS exactly the target location)
        ["gfx"] = 0,        -- Grafic effect that is shown on the position the spell hitted
...
M.CasterEffects = {
    ["minSkill"] = {                -- effects that are caused in case the caster has to minimum needed skill
        ...
        ["foodpoints"]   =  5000,   -- increase of the foodlevel
    ...
    ["maxSkill"] = {                -- effects that are caused in case the caster has the maximum needed skill
        ["hitpoints"]    =     0,   -- increase of the hitpoints
        ["foodpoints"]   = 30000,   -- increase of the foodlevel
