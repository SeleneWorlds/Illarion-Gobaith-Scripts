...
M.Script = "m_03_11_16_23_24_icewall.lua";
...
M.Settings = {
    ["Runes"] = "HEPT IRA ANTH DUN QWAN",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
