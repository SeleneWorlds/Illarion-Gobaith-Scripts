...
M.Script = "m_15_16_24_25_thunderstorm.lua";

-- Skill related spell settings
M.Skill = {
    ["min"]  =         35,  -- minimal Skillvalue needed to cast the spell
...
M.Settings = {
    ["Runes"] = "JUS PHERC DUN QWAN",  -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
...
M.SpellEffects = {
    ...
    [1] = {                 -- Radius 1 around the target location
        ["gfx"] = {2,0},  -- Graphic effect that is shown on this radius (one of the list is chosen)
...
M.TimeEffects = {
    ...
    ["msg"] = {             -- The messages that are shown before the time delay is started in german and english
        [CPlayer.german ] = "#me beginnt mit einer mystischen Formel und in {PP}n H�nden beginnen kleine Blitze zu zucken.",
        [CPlayer.english] = "#me starts with a mystical formula and in {PP} hands smalls thunderbolts appear."
    }
}
