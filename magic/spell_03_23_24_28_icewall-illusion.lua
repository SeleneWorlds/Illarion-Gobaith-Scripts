...
M.Script = "m_03_23_24_28_icewall-illusion.lua";
...
M.Settings = {
    ["Runes"] = "HEPT ANTH DUN LHOR",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
