...
M.Script = "m_11_14_16_23_poisoncloud.lua";
...
M.Settings = {
    ["Runes"] = "YEG IRA ANTH QWAN",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
