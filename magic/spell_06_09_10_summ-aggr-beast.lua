local Base = require("magic.base.creaturspell")
local basics = require("magic.base.basics")

local M = {}

-- setting the filename of the current script. This is needed to exchange them later if needed while runtime
M.Script = "m_06_09_10_summ-aggr-beast.lua";
...
M.Settings = {
    ["Runes"] = "URA TAUR LUK",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
...
M.Monsters = { 121, 122, 241, 132 };  -- IDs of monsters that could be created
