...
M.Script = "m_02_04_24_extinguish-fire-area.lua";
...
M.Settings = {
    ["Runes"] = "RA TAH DUN",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
...
M.SpellEffects = {
    ...
    [1] = {                 -- Radius 1 around the target location
        ["gfx"] = 4,        -- Grafic effect that is shown on radius 1
    ...
    [2] = {                 -- Radius 2 around the target location
        ["gfx"] = 4,        -- Grafic effect that is shown on radius 2
    ...
    [3] = {                 -- Radius 3 around the target location
        ["gfx"] = 4,        -- Grafic effect that is shown on radius 3
    ...
    [4] = {                 -- Radius 4 around the target location
        ["gfx"] = 4,        -- Grafic effect that is shown on radius 4
    ...
    [5] = {                 -- Radius 5 around the target location
        ["gfx"] = 4,        -- Grafic effect that is shown on radius 5
