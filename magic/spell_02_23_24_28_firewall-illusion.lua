...
M.Script = "m_02_23_24_28_firewall-illusion.lua";
...
M.Settings = {
    ["Runes"] = "RA ANTH DUN LHOR",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
...
M.Wall = {
    ...
    ["gfx"] = 9,                -- gfx shown in case a item is created on the wall
    ["sfx"] = 7,                -- sfx played in case a item is created on the wall
