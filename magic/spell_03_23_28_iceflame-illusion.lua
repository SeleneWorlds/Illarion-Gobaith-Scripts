...
M.Script = "m_03_23_28_iceflame-illusion.lua";
...
M.Settings = {
    ["Runes"] = "HEPT ANTH LHOR",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
