...
function M.UseItem(User, SourceItem, TargetItem, Counter, Param) 
      if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then 
          ...
          if base_books.InitBook() then 
             ...
             base_books.AddEnglishBookText("A long time ago happened a situation in the town of Albar to midday on a late summerday. The sun stood high and looped behind many clouds on a blue sky. The heat was clear to feel when not a cool",0,50,0); 
             base_books.AddEnglishBookText("wind blew through the alleys and houses. On the market was a busy ado where everyone tried to offer his wares for sale and the mountebanks enforce hearing on the top of their voices. Here and there",0,50,0); 
             base_books.AddEnglishBookText("were townguards which enforced authority with stern looks and paid attention that at best no one aquires stupid cogitations.\n Probably no one in this crowd paid attention to the old blind who,",0,50,0); 
             ...
             base_books.AddEnglishBookText("hand of the old man and pushed him aside once again.\n With a handy movement the fat man hustled the ring on his pinky finger but it wouldn't fit. He cursed and pulled on it but he couldn't remove it",0,50,0); 
             base_books.AddEnglishBookText("either. A pretty jinxed situation, like every person will find soon enough, because just in the moment when he removed the ring with a usurping jerk, he didn't have a ring in his hand but a living",0,50,0); 
             base_books.AddEnglishBookText("golden snake which seemed to grow. Fizzling and as quick as a flash the snake meandered around his neck and hedged tighter around it. A miserable stertorousness was the last thing that escaped from",0,50,0); 
             base_books.AddEnglishBookText("this fat man befor he choked and fell to the floor.\n \nFrom the old man was no trace left, he seemed to have vanished. ",0,50,0); 
             ...
             base_books.AddEnglishBookText("\n \nGynk's Lesson",0,0,1); 
             base_books.AddEnglishBookText("A few months later happened an entire different situation in one of the capitols of the Gynkeesh, which county to the free human merchant folk. It was early in the morning and there weren't many",0,50,1); 
             base_books.AddEnglishBookText("people to be seen on the streets. Only a few women rolled their barrels to the river to fill them with drinking water for the upcoming days. Some merchants were busy to prepare their stand for the",0,50,1);              
             base_books.AddEnglishBookText("day, another was on his way with a big cart, which was loaded with goods like wine, wool, oats, cabbage and other food. After this cart came another one, which was followed by another one and so on.",0,50,1); 
             base_books.AddEnglishBookText("It might look a little bit weird for people from other countries to see this long caravan of carts but apparently was this merchant one of the biggest for goods like that in the nearer surrounding.",0,50,1); 
             base_books.AddEnglishBookText("So was this proud man standing in the front of the first cart and led the caravan through the city to its destination. When someone stood in his way he or she was just ran over - here clearly obtained",0,50,1); 
             base_books.AddEnglishBookText("his right and when He drove right here everyone had to leave \"his\" street. It just was like that and it would stay like that when not a old blind man stood on the side of the street suddenly, who",0,50,1); 
             base_books.AddEnglishBookText("shouted his name loudly and waved with his hand. It didn't concern him much, after all he was a well-known person but something on the old man caught his attention. He seemed to hold a golden ball in",0,50,1); 
             base_books.AddEnglishBookText("his hand and swung it from side to side. Curiously the merchant shouted loudly to bring all his carts to a stand and jumped from his cart. He approached the ragged one and said to him: \"What do you",0,50,1); 
             base_books.AddEnglishBookText("have sucha big, golden ball here, old man? You surely stole it somewhere!\".\n \"No, no sir. You're wrong, it was laying here around! I stumbled over it and now I don't know where to with it.\"",0,50,1); 
             base_books.AddEnglishBookText("\"Was laying here around, hm? I do not believe you a word, old guy. You better give me the ball, I'll take it and ask in my circle of friends to whom it belongs! I'm a strong personality.\" said",0,50,1); 
             base_books.AddEnglishBookText("the merchant and smiled self-confident. Of course he would keep the ball for himself and receive a great price for it. He could make some dreams come true with it and of course accumulate more wealth.",0,50,1); 
             base_books.AddEnglishBookText("\"Very noble of you, sir. Take it than, take it!\" said the old man and threw it to the feet of the merchant. He bend down and wanted to pick it up. It was terribly heavy, but his greed was that big",0,50,1); 
             base_books.AddEnglishBookText("that he pulled it up with all his strenght and brought it to his cart. It seemed to him that it became heavier and in the end he needed to let it fall. In all the effort he lost sight of the old man,",0,50,1); 
             base_books.AddEnglishBookText("so it seemed now that he vanished into thin air. He shruged and turned back to the nasty ball but didn't trust his eyes. That, what was a ball made of pure gold before, transformed in something",0,50,1); 
             base_books.AddEnglishBookText("misshaped. A buz could be heared. At first quiet but it grew louder and finally it was so loud that he had to cover his ears. Now everything happened like a flash: There was a band and he found",0,50,1); 
             base_books.AddEnglishBookText("himself in a swarm of golden bugs, which ignored him and flew on the shortest way to everything what he had loaded on his carts and ate it withing seconds. They refrshed themselves on everything they",0,50,1); 
             base_books.AddEnglishBookText("could find, rose high into the sky, twanged away and were never seen again.",0,50,1); 
--             base_books.AddEnglishBookText("burning was burning nevertheless in the dusty and dry city. Everyone somehow followed his work except for a few begger who made themselves comfortable in some shadowly palces to relax a little but or",0,50,1); 
--             base_books.AddEnglishBookText("to enjoy the wine they bought from the panhanded money. Although the Salkamaerians were known to be honorable, one considered to avoid the begger and poor ones of the city. They were not hated but",0,50,1); 
--             base_books.AddEnglishBookText("avoided.\n A lonely man was sitting there under a slim tree and snoozed a bit, when he suddenly got a visitor. An old, blind dodderer greeted him friendly. \"Hello my friend, may I join you?\" he said",0,50,1); 
--             base_books.AddEnglishBookText("and smiled friendly. The lonely looked up shortly and noded slowly. \"Sure, sit down, as long as you don't take the shadow from me or disturb me somehow!\" he said; followed by a dirty, broad grin.",0,50,1); 
--             base_books.AddEnglishBookText("Instead of sitting down the blind kept standing and moved his head towards the lonely. He stared so intensive that one could mean hat he actually had eyes under his bandage with which he could",0,50,1); 
--             base_books.AddEnglishBookText("observe everthing.Like a statue he stood there, bending forward slightly. \"What are you standing there? When you want to sit down, sit down, otherwise don't stare at me and keep you trab shut!\"",0,50,1); 
--             base_books.AddEnglishBookText("said the lonely harsh. Then one could suddenly see a movement in the legs of the blind. He leaned back and finally sat down next to the lonely. With one hand he stroked over his beard, pulled slightly",0,50,1); 
--             base_books.AddEnglishBookText("on it as if he was thinking and looked with a absent gaze down the street. Now the old man started to talk, leaving the gaze how it was. \"You know, I travelled long under the human and I watched",0,50,1); 
--             base_books.AddEnglishBookText("them. I tested them of their believe and their longings. And everwhere the humans are the same, the rich and the poor! They take what they can get and are greedy and aggressive. And no big city of men",0,50,1); 
--             base_books.AddEnglishBookText("may it be what so famous was different.\" explained the old man in slow, thoughful words. \"And now I'm sitting here with you, one armed man! Do not get disturbed by me philosophising Maybe it is a",0,50,1); 
--             base_books.AddEnglishBookText("test on you, I tell you openly! I wan't to test you as well. Until now I didn't loose the trust into men!\" he said and smiled faintly. In the lonely happened a change; but it wasn't of positive",0,50,1); 
--             base_books.AddEnglishBookText("nature. He frowned and looked to the old one \"What are you talking there for a bullshit, old man? Get lost!\" he said angry and beat with the hand in direction of the old. Hit with pain the old stood",0,50,1); 
--             base_books.AddEnglishBookText("up quickly and hobbled away, his face branded with sadness and disappointed. The lonely grined broadly behind him jeered and bellowed of happiness. On the next day he was found in some alley, first",0,50,1); 
--             base_books.AddEnglishBookText("up quickly and hobbled away, his face branded with sadness and disappointed. The lonely grined broadly behind him jeered and bellowed of happiness. On the next day he was found in some alley, first",0,50,1); 
--             base_books.AddEnglishBookText("robbed and then killed; probably from his own kind.\n \nThe old man was never seen again.",0,50,1); 
             ...
             base_books.AddEnglishBookText("The last scene where the old strange bild was seen, was the great city Salkamaeria. It was late afternoon but the heat",0,50,2); 
             base_books.AddEnglishBookText("burning was burning nevertheless in the dusty and dry city. Everyone somehow followed his work except for a few begger who made themselves comfortable in some shadowy places to relax a little but or",0,50,2); 
             base_books.AddEnglishBookText("to enjoy the wine they bought from the panhanded money. Although the Salkamaerians were known to be honorable, one considered to avoid the begger and poor ones of the city. They were not hated but",0,50,2); 
             ...
             base_books.AddEnglishBookText("and smiled friendly. The lonely looked up shortly and noded slowly. \"Sure, sit down, as long as you don't take the shadow from me or disturb me somehow!\" he said; followed by a dirty, broad grin.",0,50,2); 
             base_books.AddEnglishBookText("Instead of sitting down the blind kept standing and moved his head towards the lonely. He stared so intensive that one could mean hat he actually had eyes under his bandage with which he could",0,50,2); 
             base_books.AddEnglishBookText("observe everthing.Like a statue he stood there, bending forward slightly. \"What are you standing there? When you want to sit down, sit down, otherwise don't stare at me and keep you trab shut!\"",0,50,2); 
             base_books.AddEnglishBookText("said the lonely harsh. Then one could suddenly see a movement in the legs of the blind. He leaned back and finally sat down next to the lonely. With one hand he stroked over his beard, pulled slightly",0,50,2); 
             base_books.AddEnglishBookText("on it as if he was thinking and looked with a absent gaze down the street. Now the old man started to talk, leaving the gaze how it was. \"You know, I travelled long under the human and I watched",0,50,2); 
             base_books.AddEnglishBookText("them. I tested them of their believe and their longings. And everwhere the humans are the same, the rich and the poor! They take what they can get and are greedy and aggressive. And no big city of men",0,50,2); 
             base_books.AddEnglishBookText("may it be what so famous was different.\" explained the old man in slow, thoughful words. \"And now I'm sitting here with you, one armed man! Do not get disturbed by me philosophising Maybe it is a",0,50,2); 
             base_books.AddEnglishBookText("test on you, I tell you openly! I wan't to test you as well. Until now I didn't loose the trust into men!\" he said and smiled faintly. In the lonely happened a change; but it wasn't of positive",0,50,2); 
             base_books.AddEnglishBookText("nature. He frowned and looked to the old one \"What are you talking there for a bullshit, old man? Get lost!\" he said angry and beat with the hand in direction of the old. Hit with pain the old stood",0,50,2); 
             base_books.AddEnglishBookText("up quickly and hobbled away, his face branded with sadness and disappointed. The lonely grined broadly behind him jeered and bellowed of happiness. On the next day he was found in some alley, first",0,50,2); 
             base_books.AddEnglishBookText("up quickly and hobbled away, his face branded with sadness and disappointed. The lonely grined broadly behind him jeered and bellowed of happiness. On the next day he was found in some alley, first",0,50,2); 
             ...
             base_books.AddEnglishBookText("street started the brushwood and the thicket through which one could hardly pass. Through this forest wandered an old man one day, the eyes covered with a bandage. Slowly and thoughtful he went",0,50,3); 
             base_books.AddEnglishBookText("through the forest. The habitantsa of the surrounding towns would have called the old man crazy for that he passes through the forest alone. Everyone knows that thieves and domestics lurk around.",0,50,3); 
             base_books.AddEnglishBookText("It didn't take long until happened what must have happened. With loud steps jumped a figure out if bushes and stopped right in front of the old man. \"Give me everything you have.\" he screamed with",0,50,3); 
             base_books.AddEnglishBookText("a shrill voice. The old man didn't move a bit and hold on to his crutch. The person which just jumped out of the brushwood seemed to be confused by this calmness. The thief only had one arm in which",0,50,3); 
             base_books.AddEnglishBookText("he hold a small, rusty knief, the other arm was a stump. The old one still didn't move: \"What's wrong? Didn't you hearm me right? Give me everything you have or I cut you open!\" screamed the bandit",0,50,3); 
             base_books.AddEnglishBookText("and started slowly to shake. Somehow this figure in front of him madehim nervous. The old man wasn't like the other people he robbed: People who screamed loudly and immediatly gave him everything they",0,50,3); 
             base_books.AddEnglishBookText("owned or others which started to fight. The old one seemed to be unimpressed and instead to move, he suddenly started to talk: \"What happened to your arm? Why does a young man like you rob an old man",0,50,3); 
             base_books.AddEnglishBookText("like me in the forest?\" he said calmly. Totally confused the thief scratched his head with his knief. Why does this blind guy know that he only has one arm? Again he said: \"Give me your things!",0,50,3); 
             base_books.AddEnglishBookText("Please, give them to me!\" This time with less force and somehow it sounded as if he aline was ntimidated. \"Now tell me young man. Why do you murder? Why do you rob? Shame on you! Shame!\" the old",0,50,3); 
             base_books.AddEnglishBookText("man blustered loudly. Something in the young bandit changed. With an angry voice he said: \"I... have nothing! I need to feed my family from something! I have three children and a wife who are",0,50,3); 
             base_books.AddEnglishBookText("hungry! They are more important to me than anything else and I'm a small thief! Do you even know how lousy I have to reside, man?! Thievery is everything I have left!\". It sounded as if he wanted",0,50,3); 
             base_books.AddEnglishBookText("to justify himself; as if he had an excuse for thievery! \"Yes, I heard right, I'm a thief but I would die otherwise and I stand to it!\" bubbles it out of his mouth. The old man seemed to be calmed",0,50,3); 
             base_books.AddEnglishBookText("down a bit. He said again: \"Well, well and that is the reason you are missing one arm, hm? Because thieves lose one so they can't steal anymore.\" Then suddelny the bitter face vanished from the old",0,50,3); 
             base_books.AddEnglishBookText("man and he started to smiled heartly. \"You are the first person for a long time who tells the truth! You are a thief, filth but your intentions are right and you're ashamed for your deeds, I can see",0,50,3); 
             base_books.AddEnglishBookText("it in your face!\" he said slowly and still smiled. \"The gods would surely give you a second chance but what could I do? I'm a broken man and except for this sand I do not own anything. But you know",0,50,3); 
             base_books.AddEnglishBookText("what? I give it to you than you do not need to rob me. But hold on to your intentions.\" said the old man and took the knief from the hand of the bandit. Then he reached into his won bag, pulled",0,50,3); 
             base_books.AddEnglishBookText("something out and pressed it into the hand of the young bandit. Curiously he opened his hand and in the next moment gleamed golden sand which shimmered wonderful in the crepuscular light of the",0,50,3); 
             base_books.AddEnglishBookText("forest. Paralysed by the moment he couldn't loosen the sight from it. But suddenly the sand started to fade and turned into dirty earth which trickled through his fingers to the ground and vanished",0,50,3); 
             base_books.AddEnglishBookText("forest. Paralysed by the moment he couldn't loosen the sight from it. But suddenly the sand started to fade and turned into dirty earth which trickled through his fingers to the ground and vanished",0,50,3); 
             base_books.AddEnglishBookText("A cold wind blew through the forest and blew him the hair around his ears. In thoughts he still wondered about the words of the blind man. Uncomprehending he looked to him. At least he wanted to",0,50,3); 
             base_books.AddEnglishBookText("the old man but he was gone. The thief sttod alone in the forest on a small path, next to him on the ground layes a small knief and a pile of dirt which trickled through his fingers. Confused",0,50,3); 
             base_books.AddEnglishBookText("he grabbed his head as if he wanted to check if he has an illness of fever. All the more was the shock when he realised that had touched his forehead with the wrong hand. He started to scream loud,",0,50,3);    
             base_books.AddEnglishBookText("hysterical and frighetened. On his right shoulder was an arm instead of the stumb which was there before. The hand of his arm was the one with wich he stroked over his face It was without a doubt his",0,50,3);    
             base_books.AddEnglishBookText("own.\n \nTo his feet he found the blindfold of the old one, who is missing until today.",0,50,4);    

             ------------
             
            base_books.AddLanguage("dwarf language",4 );
            base_books.AddEnglishBookText( "\"I pledge that I will devote the purpose and the power given to me, to aid the community of Silverbrand, and to protect them against wrong. ", 0, 0, 4 );
            base_books.AddEnglishBookText( " To fulfil my duties with honour. And so we may prosper. I vow to reign Just, with no exceptions. ", 0, 0, 4 ); 
            base_books.AddEnglishBookText( " My command ceases at the borders of Silverbrand.\" Tialdin, King of Silverbrand ", 0, 0, 4 );
            base_books.AddEnglishBookText( " Long awaited, it has finally come to pass. The Dwarfs have chosen their king. For now, there is one who will guide them, one who will contend for them. ", 0, 0, 4 );
            base_books.AddEnglishBookText( " Here also will today be announced, which Dwarfs will be employed with office and duty. ", 0, 0, 4 ); 
            base_books.AddEnglishBookText( " Our fellow Dwarf Rugosch will find his place next to the king. He stands for the beliefs to our god of Dwarfs Irmorom. One for all those who seek advice, even the king himself. ", 0, 0, 4 );
            base_books.AddEnglishBookText( " Furthermore, our well known and much respected fellow Dwarf Bombor will be positioned as Herald of Silverbrand. ", 0, 0, 4 );  
            base_books.AddEnglishBookText( " He will be our negotiator in times of war as in times of peace. His word will carry the demands of the king at all times. His voice is, the voice of the king.", 0, 0, 4 );
            base_books.AddEnglishBookText( " On a further note, the Clan of the Axe under the leadership of their own announced chief will be charged with the duty of Sentinels. ", 0, 0, 4 );  
            base_books.AddEnglishBookText( " When all diplomatic efforts have failed, they will be the ones to inflict destruction upon our enemies. ", 0, 0, 4 );
            base_books.AddEnglishBookText( " They will determine wrongdoings and protect the boarders so that no harm may enter Silverbrand. Every visitor will conform to the regulations upheld by these Sentinels. ", 0, 0, 4 );  
            base_books.AddEnglishBookText( " To arrest any confusion, every Dwarf who wishes to vow his communal pledge to Silverbrand may do so and be registered in the communal listings. All Dwarfs are welcomed in our halls. ", 0, 0, 4 );
            base_books.AddEnglishBookText( " The community list will be placed out on display so all that feel that they have fulfilled the pledge may sign and be added. ", 0, 0, 4 );  
            base_books.AddEnglishBookText( " I thank all Dwarfs who have entrusted their faith in me and am pleased that the thought of creating our own realm has fruited with so many. ", 0, 0, 4 );
            ...
            base_books.AddEnglishBookText("\n\n~~Topaz~~",198,0,5);
            base_books.AddEnglishBookText("The energies of Topaz appear to have the most different effects, independent of the item you let them flow into.",0,0,5);
            base_books.AddEnglishBookText("This is why magic topaz are used and appreciated by nearly all stratums. They tend to belong to the most rare gems, they are also the most valuable.",0,0,5);
            base_books.AddEnglishBookText("Weapons: The energies of magic topaz that are bound in a weapon are used to sharpen the blade and therefore cause more damage.",205,0,5);
            base_books.AddEnglishBookText("Armors and shields: Topaz energies enhance protection against slashing damage.",2403,0,5);
            base_books.AddEnglishBookText("Magic wands: Topaz energies flowing through wands enhance the mana regeneration of their bearers.",2782,0,5);
            base_books.AddEnglishBookText("Tools: Items crafted by a tool empowered by topaz energies have a better quality than usual.",724,0,5);
            base_books.AddEnglishBookText("Trinkets: In trinkets, magic energies tend to raise the essence as well as the willpower of the bearer. Although, both of these attributes are only raised half as strong as they are by other trinkets.",83,0,5);
            ...
            base_books.AddLanguage("lizard language",6);

			base_books.AddEnglishBookText("Written down from\nDarzog,\nnovice of Tanora\n\ntranslate by\nAshayen Cromwell",0,20,6);
			...
			base_books.AddLanguage("common language",7);

			base_books.AddEnglishBookText("Brewyn the Liar\n \n \n by P. Woodscribe",0,5,7);
			base_books.AddEnglishBookText("\n This story begins in a house, by a fire.\n Propped in his armchair sat Brewyn, a liar.\n",0,5,7);
			base_books.AddEnglishBookText("Now I warn you this story, is not for the faint of heart.\n This halfer's morals were quite far apart.\n \n",0,5,7);
			base_books.AddEnglishBookText("So in a chair he sat, free of labour and strife.\n Wherein, through the hill door, stepped Annie, his wife.\n",0,5,7);
			base_books.AddEnglishBookText("She stooped to his side, and assaulted his ear.\n She nagged, whilst he pretended not to hear.\n\n",0,5,7);
			base_books.AddEnglishBookText("\"This harvest,\" she scolded, \"has not been brought in.\"\n \"And those cloaks,\" she informed him, \"have worn very thin.\"\n",0,5,7);
			base_books.AddEnglishBookText("\"You have chores not done, and that condemns us ill.\"\n \"And by winter, I tell you, your tummy won't fill!\"\n \n",0,5,7);
			base_books.AddEnglishBookText("With a cry and a holler, he made quite a show.\n \"Oh, blasted woman! It was done ages ago!\"\n",0,5,7);
			base_books.AddEnglishBookText("\"The fruit I picked yesterweek I stored down in the cellar.\"\n \"And new cloaks, finest of make, I just bought from some fella.\"\n \n",0,5,7);
			base_books.AddEnglishBookText("He prodded and teased her, made a big deal.\n \"The bitter and cold, this Fall you won't feel!\"\n",0,5,7);
			base_books.AddEnglishBookText("\"I've worked and I've worked. Worked myself red!\"\n \"I did this and more, just to keep you fed!\"\n \n",0,5,7);
			base_books.AddEnglishBookText("With that he stormed out the door, all in a huff.\n But when, out of sight, he cried \"I still need all that stuff!\"\n",0,5,7);
			base_books.AddEnglishBookText("He rushed in a panic, looking for a stall.\n But, as predicted, they had closed for the Fall.\n \n",0,5,7);
			base_books.AddEnglishBookText("Every Halfling, everyone who had worked oh-so-hard,\n had all been ready, even the bard.\n",0,5,7);
			base_books.AddEnglishBookText("All sat cosy, with food and with wine.\n The work month was over, so they had a good time.\n \n",0,5,7);
			base_books.AddEnglishBookText("Brewyn knocked on their doors, but to no avail.\n None like a liar and so none answered his hail.\n",0,5,7);
			base_books.AddEnglishBookText("Brewyn sat and he cried, all in a pity.\n When down fluttered a fairy, to sing him a ditty!\n \n",0,5,7);
			base_books.AddEnglishBookText("\"Please listen dear, as I do this dance,\n I shall, as a fairy, give you one chance.\"\n",0,5,7);
			base_books.AddEnglishBookText("\"If in truth you answer, then you shall be spared.\"\n \"If a lie, you tell, then you should be scared.\"\n \n",0,5,7);
			base_books.AddEnglishBookText("She asked her question, and watched how he fared.\n \"Next year, and next harvest...will you be prepared?\"\n",0,5,7);
			base_books.AddEnglishBookText("He did do his best, he really did try.\n But when he open his lips, out popped a lie.\n \n",0,5,7);
			base_books.AddEnglishBookText("\"Well I would've been ready,\" he said, the loudest he could've.\n \"If you hadn't have stopped me, I probably would've!\"\n",0,5,7);
			base_books.AddEnglishBookText("With a scowl, the fairy flew far away.\n \"If you hadn't lied, you'd have lived another day.\"\n \n",0,5,7);
			base_books.AddEnglishBookText("Brewyn hung his head, and made for his hill.\n Annie was right...they were condemned ill.\n",0,5,7);
			base_books.AddEnglishBookText("The liar sat right back down in his seat.\n The unfortunate sod, simply relaxed his feet.\n \n",0,5,7);
  ...
  function LookAtItem(User,Item) 
      if base_books.InitTitle() then 
          base_books.AddGermanBookTitle("Buch mit dem Titel \"Der Alte Mann, Buch 1\"",0);
          base_books.AddEnglishBookTitle("Book with the title \"Old Man's Tale, Book 1\"",0); 
          
          base_books.AddGermanBookTitle("Buch mit dem Titel \"Der Alte Mann, Buch 2\"",1);
          base_books.AddEnglishBookTitle("Book with the title \"Old Man's Tale, Book 2\"",1);
          
          base_books.AddGermanBookTitle("Buch mit dem Titel \"Der Alte Mann, Buch 3\"",2);
          base_books.AddEnglishBookTitle("Book with the title \"Old Man's Tale, Book 3\"",2);
          
          base_books.AddGermanBookTitle("Buch mit dem Titel \"Der Alte Mann, Buch 4\"",3);
