...
function M.UseItem(User, SourceItem, TargetItem, Counter, Param) 
      if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then 
          ...
          if base.books.InitBook() then 
             ...
             base.books.AddGermanBookText("Vor langer Zeit ereignete sich eine Gegebenheit in der Stadt Albar, zur Mittagszeit an einem Sp�tsommertag hin. Die Sonne stand hoch und wand sich hinter vielen Wolken und einem blauen Himmel. Die",0,50,0); 
             base.books.AddGermanBookText("W�rme war deutlich zu sp�ren, wenn nicht gerade ein k�hler Wind durch die Gassen und H�user blies. Auf dem Markt herrschte reges Treiben, wo ein Jeder versuchte, seine Waren feilzubieten und die",0,50,0); 
             base.books.AddGermanBookText("Marktschreier sich lauthals Geh�r verschafften. Hier und da waren Stadtwachen, die sich mit strengen Blicken autorith�t verschafften und aufpassten, dass m�glichst niemand auf dumme Gedanken k�me.",0,50,0); 
             base.books.AddGermanBookText("In dieser Masse bemerkte sicherlich niemand den alten Blinden, der, auf seine Kr�cke gest�tzt, durch die Stra�en wanderte und seinen Umhang enger um den Hals schlug, als sei ihm entweder kalt, oder er",0,50,0); 
             base.books.AddGermanBookText("w�rde versuchen, seine Scham zu verbergen, dass er in einem solch j�mmerlichen Zustand war: seine Kleidung war alt, und sie stank. Bis auf die schmutzige Augenbinde, war nicht viel von seiner Mimik",0,50,0); 
             base.books.AddGermanBookText("zu erkennen. Weder l�chelte er, noch zeigte er sonst eine Expression.\n So wanderte dieser Alte nun, als ihm eine Schar von Menschen entgegenkam. Er konnte zwar nicht ausmachen, was genau da auf ihn",0,50,0); 
             base.books.AddGermanBookText("zukam, doch seine Ohren verliehen ihm eine weitaus bessere Gabe, die Dinge aufzufassen. Und so schien es, als w�re es ein Trupp von Soldaten, oder �hnlich bewaffneten Personen. Anstatt ihnen",0,50,0); 
             base.books.AddGermanBookText("auszuweichen, ging er geradewegs in die Masse von Leuten herein. Im n�chsten Augenblick wurde er auch schon unsanft zur�ckgesto�en und landete hart auf dem Boden.\n \"Verzieh dich, du Penner! Was",0,50,0); 
             base.books.AddGermanBookText("f�llt dir ein, dem gro�en Hohepriester Br�gons im Weg herumzustehen? Scher dich fort\" schien einer der bewaffneten ihn anzuschnauzen. Der Alte rappelte sich ganz gem�chlich auf, lehnte sich wieder",0,50,0); 
             base.books.AddGermanBookText("auf seine Kr�cke und ganz pl�tzlich sah man ein L�cheln auf seinen Lippen. \"Aber, aber, mein werter Herr. Seid nicht zornig, bitte nicht! Ich habe hier eben diesen goldenen Ring gefunden, und ihr",0,50,0); 
             base.books.AddGermanBookText("k�nnt mir doch sicher sagen, wem er geh�rt, habe ich recht?\"\n Mit diesem Satz zog der Alte einen unscheinbaren goldenen Ring aus seiner Tasche und hielt ihn h�her in die Luft. \"Ein Ring aus Gold?",0,50,0); 
             base.books.AddGermanBookText("Gib ihn her, sofort! Ich will ihn haben, er geh�rt mir und meiner heiligen Sache!\" h�rte der Alte nun eine andere Stimme, die etwas geschwollener klang und irgendwie musste dieser sprechende Mensch",0,50,0); 
             base.books.AddGermanBookText("Gib ihn her, sofort! Ich will ihn haben, er geh�rt mir und meiner heiligen Sache!\" h�rte der Alte nun eine andere Stimme, die etwas geschwollener klang und irgendwie musste dieser sprechende Mensch",0,50,0); 
             base.books.AddGermanBookText("wahnsinnig fett gewesen sein. Ein ekliges Lachen folgte, als man dem alten Mann den Ring aus der Hand riss und ihn wieder davonstie�.\n Mit einer geschickten Bewegung schob sich der fettleibige",0,50,0); 
             base.books.AddGermanBookText("Priester den Ring �ber den kleinen Finger, doch wollte er nicht passen. Er fluchte, zog daran, doch abziehen konnte er ihn auch nicht. Eine ziemlich verhexte Situation, wie jener Mensch schon bald",0,50,0); 
             base.books.AddGermanBookText("finden w�rde, denn just als es ihm gelang, den Ring mit einem gewaltsamen Ruck abzuziehen, hatte er keinen Ring mehr in der Hand, sondern eine lebensechte goldene Schlange, die zu wachsen schien.",0,50,0); 
             base.books.AddGermanBookText("Zischend und blitzschnell schl�ngelte sie sich um seinen Hals und wand sich immer enger. Ein kl�gliches R�cheln war das letzte, was dem dicken Kerl entwich, bevor er erstickte und zu Boden fiel.",0,50,0); 
             ...
             base.books.AddEnglishBookText("to your mind by standing in the way of the high priest of Br�gon? Go away!\" seemed to scream one of the weaponed. The old man got slowly back on his feet and leaned once again on his crutch and",0,50,0); 
             ...
             base.books.AddGermanBookText("Ein paar Monate sp�ter ereignete sich eine ganz andere Situation in einer der Hauptst�dte der Gynkeesh, die zu den freien menschlichen Handelsv�lker z�hlen. Es war fr�h am Morgen, und auf den Stra�en",0,50,1); 
             base.books.AddGermanBookText("waren nochnicht viele Menschen zu sehen. Nur ein paar Frauen rollten ihre F�sser zum Fluss, um sie f�r die kommenden Tage mit Trinkwasser zu f�llen. Mancher H�ndler war schon dabei, seinen Stand f�r",0,50,1); 
             base.books.AddGermanBookText("den Tag vorbereiten und ein anderer war mit einem gro�en Karren unterwegs, der voll beladen mit G�tern wie Wein, Wolle, Hafer, Kohl und anderen Nachrungsmitteln war. Dahinter noch ein Karren, dann",0,50,1); 
             base.books.AddGermanBookText("noch einer und so weiter. Es mag f�r Menschen aus anderen Gefilden merkw�rdig sein, diese ziemlich lange Karawane von Karren zu sehen, aber scheinbar war dies einer der gr��ten H�ndler f�r Waren",0,50,1); 
             base.books.AddGermanBookText("dieser Art in der n�heren Umgebung.\n So stand dieser stolze Kerl also vorne auf dem ersten Wagen und lenkte die Wagenkolonne mitten durch die Stadt zum Bestimmungsort, wo sie hinsollte. Wenn jemand",0,50,1); 
             base.books.AddGermanBookText("im Weg stand, so wurde er einfach �berrollt - Hier galt ganz klar sein Recht, und wenn Er hier fuhr, dann hatten alle anderen von \"seiner\" Stra�e zu gehen. So war das nunmal, und dabei w�rde es auch",0,50,1); 
             base.books.AddGermanBookText("bleiben, w�re da nicht pl�tzlich dieser alte blinde Mann am Stra�enrand, der lautstark seinen Namen rief und mit einem Arm winkte. Es k�mmerte ihn nicht sonderlich, schlie�lich war er eine sehr",0,50,1); 
             base.books.AddGermanBookText("Bekannte Person, doch dann erregte etwas an dem Alten seine Aufmerksamkeit. Er schien eine goldene Kugel in der Hand zu halten und sie hin und herzuschwenken. Neugierig rief der H�ndler lautstark, um",0,50,1); 
             ...
             base.books.AddGermanBookText("kein Wort, alter Kerl. Du gibst mir besser die Kugel, ich werde sie nehmen und in meinem Bekanntenkreis herumfragen, wem sie geh�rt! Ich bin eine starke Pers�nlichkeit.\" sagte der H�ndler und",0,50,1); 
             base.books.AddGermanBookText("l�chelte selbstsicher. Nat�rlich w�rde er die Kugel f�r sich behalten und einen tollen Preis daf�r erhalten. Damit k�nnte er sich dann so einige W�nsche erf�llen, und nat�rlich nochmehr Reichtum",0,50,1); 
             base.books.AddGermanBookText("anh�ufen.\n \"Sehr nobel von euch, mein Herr. So nehmt sie, nehmt sie!\" sprach der Alte und warf sie dem H�ndler vor die F��e. Dieser b�ckte sich nach der Kugel und wollte sie aufheben. Sie war",0,50,1); 
             base.books.AddGermanBookText("furchtbar schwer, aber seine Gier war so gro�, dass er sie mit aller Kraft hochzog und zu seinem Karren brachte. Es kam ihm vor, als w�rde sie immer schwerer und schlie�lich musste er sie",0,50,1); 
             base.books.AddGermanBookText("fallenlassen. In all der Anstrengung hatte er den Alten aus den Augen verloren, so schien es nun, also w�re er von der Bildfl�che verschwunden. Mit den Schultern zuckend wandte er sich nun wieder der",0,50,1); 
             base.books.AddGermanBookText("garstigen Kugel zu, traute jedoch seinen Augen nicht. Das, was vorher eine Kugel aus purem Gold war, verwandelte sich in etwas unf�rmiges. Ein Brummen war zu h�ren. Erst leise, dann immer lauter, und",0,50,1); 
             base.books.AddGermanBookText("schlie�lich war es so laut, dass er sich die Ohren zuhalten musste. Nun ging alles blitzschnell: Es gab einen Knall und schon war in einem Schwarm aus surrenden goldenen K�fern, die ihn jedoch",0,50,1); 
             base.books.AddGermanBookText("ignorierten und schnurstracks auf alles zuflogen, was er auf seinen Karren geladen hatte, und es innerhalb von Sekunden aufa�en. Sie labten sich an allem, was sie fanden, erhoben sich dann hoch in",0,50,1); 
...
--             base.books.AddEnglishBookText("robbed and then killed; probably from his own kind.\n \nThe old man was never seen again.",0,50,1); 
             ...
             base.books.AddGermanBookText("Der letzte Schauplatz, an dem man den merkw�rdigen Blinden jemals sah, war die gro�e Stadt Salkamaeria. Es war sp�ter Nachmittag und dennoch",0,50,2); 
             base.books.AddGermanBookText("brannte die Hitze in der staubigen, trockenen Stadt. Jeder ging hier irgendwie seiner Arbeit nach, bis auf ein paar Bettler, die es sich an einigen schattigen Pl�tzen gem�tlich gemacht haben, um sich",0,50,2); 
             base.books.AddGermanBookText("ein wenig zu entspannen oder von dem erbettelten Geld dem Wein zu fr�hnen. Obwohl die Salkamaerikaner als sehr ehrenvoll galten, war man doch eher besonnen, den Bettlern und Armen der Stadt aus dem",0,50,2); 
             ...
             base.books.AddGermanBookText("alter, blinder Tattergreis setzte sich neben ihn und gr��te ihn freundlich. \"Hallo, mein Freund, darf ich mich zu dir setzen?\" sprach er besonnen und l�chelte freundlich. Der Einsame blickte",0,50,2); 
             base.books.AddGermanBookText("kurz auf und nickte nur langsam. \"Klar, nimm Platz, solange du mir nicht den Schatten wegnimmst oder mich irgendwie st�rst!\" sagte er; dann folgte ein breites, dreckiges Grinsen auf seinen Lippen.",0,50,2); 
             base.books.AddGermanBookText("Anstatt sich hinzusetzen, blieb der Blinde jedoch stehen und richtete seinen Kopf auf den Einsamen. Er stierte ihn so intensiv an, dass man annehmen k�nnte, er h�tte tats�chlich Augen unter der Binde,",0,50,2); 
             base.books.AddGermanBookText("mit denen er alles genaustens wahrnimmt. Wie eine Statue stand er dort, leicht nach vorne gebeugt. \"Was stehst du da so bl�d herum?\" Wenn du dich setzen willst, dann setz dich, ansonsten glotz mich",0,50,2); 
             base.books.AddGermanBookText("nicht an, und halt bloss dein Maul!\" sagte der Einsame barsch. Dann sah man pl�tzlich eine kaum wahrnehmbares Bewegung in den Beinen des Alten. Er lehnte sich zur�ck und setzte sich endlich neben den",0,50,2); 
             base.books.AddGermanBookText("Einsamen. Mit einer Hand streifte er sich �ber den Bart, zog etwas daran, als w�rde er nachdenken und schaute mit abwesendem Blick in die etwas ferner gelegenen Stra�en. Nun find der Alte an zu",0,50,2); 
             base.books.AddGermanBookText("erz�hlen, den Blick jedoch behielt er bei. \"Wisst ihr, ich bin sehr lange unter den Menschen umhergereist, und ich habe sie beobachtet. Ich habe sie auf ihren Glauben gepr�ft und auf ihre Gel�ste.",0,50,2); 
             base.books.AddGermanBookText("Und �berall sind die Menschen gleich, Reiche und Arme! Sie nehmen, was sie kriegen k�nnen und sind gierig und aggressiv. Und keine der gro�en St�dte der Menschen, sei sie noch so ber�hmt, hat sich",0,50,2); 
             base.books.AddGermanBookText("bisher irgendwie abgehoben.\" erkl�rte der Alte in langsam gesprochenen, bed�chtigen Worten. \"Und nun sitze ich bei euch, einarmiger Mann! Lasst euch nicht daran st�ren, dass ich hier philosophiere.",0,50,2); 
             base.books.AddGermanBookText("Vielleicht ist es ein Test an euch, das sage ich euch ganz offen! Auch euch m�chte ich pr�fen! Noch habe ich die Hoffnung in die Menschen nicht verloren!\" sagte er dann und l�chelte etwas. In dem",0,50,2); 
             base.books.AddGermanBookText("Einsamen ging eine Ver�nderung vor; doch war sie nicht von positiver Natur. Er legte seine Stirn in Falten, runzelte etwas und schaute dann zu dem Alten. \"Was faselst du da f�r einen Mist, alter",0,50,2); 
             base.books.AddGermanBookText("Mann? Scher dich fort!\" sagte er dann w�tend und schlug mit der Hand nach dem Alten aus. Von Pein getroffen stand der Alte schnellstens auf und humpelte davon, sein Gesicht von Trauer und",0,50,2); 
             base.books.AddGermanBookText("Entt�uschung gezeichnet. Der Einsame grinste ihm noch breit hinterher, johlte und gr�hlte vor Freude. Am n�chsten Tag fand man ihn in irgendeiner Gasse liegen, erst ausgeraubt, dann erschlagen;",0,50,2); 
             ...
             base.books.AddGermanBookText("Niemehr? Vielleicht doch, aber kann man das nicht sicher sagen, weil nie gro� dar�ber erz�hlt wurde. Es gab einen dunklen Wald, fernab von jeder Zivilisation. Sowohl Tags, als auch Nachts war es",0,50,3); 
             base.books.AddGermanBookText("dort immer dunkel, neben den Stra�en begann sofort das Unterholz und das Dickicht, durch das kaum jemand durchdringen konnte. In diesem Wald wanderte eines Tages ein alter Mann, die Augen mit einer",0,50,3);         
             base.books.AddGermanBookText("Binde abgedeckt. Langsam und bed�chtig ging er durch diesen Wald. Die Bewohner der umliegenden D�rfer h�tten diesen Alten sofort f�r geisteskrank erkl�rt, dass er sich alleine durch diesen Wald traut.",0,50,3); 
             base.books.AddGermanBookText("Weiss doch ein jeder, dass hier Diebe und Gesindel lauert. Es dauerte also auch nicht lange, bis passierte, was passieren musste. Mit lauten Schritten sprang eine Gestalt aus dem Geb�sch und stellte",0,50,3); 
             base.books.AddGermanBookText("sich vor den bliden alten Mann. \"Gib mir alles, was du hast\" schrie er mit schriller Stimme. Der Greis jedoch bewegte sich kein St�ckchen und hielt sich still auf seine Kr�cke gest�tzt. Jene Person,",0,50,3); 
             ...
             base.books.AddGermanBookText("Stumpf. Der Alte bewegte sich immernoch kein St�ckchen. \"Was ist denn los?! H�rst du schlecht? Gib mir was du hast, sonst schlitz ich dich auf!\" schrie der Bandit, und fing langsam an zu zittern.",0,50,3); 
             base.books.AddGermanBookText("Irgendwie schien ihn diese Gestalt vor ihm aus der Ruhe zu bringen. Sie war nicht wie andere Leute, die er �berfallen hatte: Personen, die laut aufschrien und sofort alles hergaben, was sie besassen.",0,50,3); 
             base.books.AddGermanBookText("Oder eben andere, die anfingen zu k�mpfen. Der Alte schien unbeeindruckt, und anstatt sich irgendwie zu bewegen fing er pl�tzlich an zu reden: \"Was ist mit eurem Arm passiert? Wieso �berf�llt ein",0,50,3); 
             base.books.AddGermanBookText("junger Bursche wie ihr einen alten schwachen Mann im Wald?\" sagte er seelenruhig. V�llig irritiert kratzte sich der Dieb mit dem Messer am Kopf. Woher wusste der blinde Kerl, dass er nur einen Arm",0,50,3); 
             base.books.AddGermanBookText("hatte? Nochmal sagte er: \"Gib mir deine Sachen! Bitte, gib schon!\", diesmal jedoch mit weniger Nachdruck und irgendwie klang es nun, als w�re er selber eingesch�chtert. \"Nun sagt es mir schon,",0,50,3); 
             base.books.AddGermanBookText("junger Mann. Wieso mordet ihr? Wieso raubt ihr? Was soll das? Sch�men solltet ihr euch! Sch�men!\" schimpfte der Alte lautstark. In dem jungen Banditen ging eine merkbare Ver�nderung vor. Mit w�tender",0,50,3); 
             base.books.AddGermanBookText("Stimme sagte er dann: \"Ich... hab' doch nichts! Irgendwovon muss ich doch meine Familie ern�hren! Ich hab' drei Kinder und eine Frau, die hungrig sind! Sie sind wichtiger als alles, was es f�r mich",0,50,3); 
             base.books.AddGermanBookText("gibt, und ich bin nur ein kleiner Dieb! Weisst du eigentlich, wie erb�rmlich ich hausen muss, alter Mann?! Diebstahl ist alles, was mir bleibt!\". Es klang so, als wolle er sich rechtfertigen; als",0,50,3); 
             base.books.AddGermanBookText("h�tte er eine Rechtfertigung f�r einen Diebstahl! \"Ja, du hast richtig geh�rt, ich bin ein Dieb, aber anders w�rde ich sterben, und ich stehe dazu!\" sprudelte es nur so aus seinem Mund. Der Alte",0,50,3); 
             base.books.AddGermanBookText("schien sich etwas beruhigt zu haben. Er sprach erneut: \"Soso, und deswegen habt ihr wohl auch keinen Arm, hm? Dieben schl�gt man den Arm ab, damit sie nichtmehr stehlen k�nnen\". Dann pl�tzlich",0,50,3); 
             base.books.AddGermanBookText("l�ste sich das verbitterte Gesicht des Alten und er fing an, herzlich zu l�cheln. \"Ihr seid der erste Mensch seit langem, der die Wahrheit sagt! Ihr seid ein Dieb, Abschaum, aber eure Absicht ist",0,50,3); 
             base.books.AddGermanBookText("gerecht und ihr sch�mt euch f�r eure Taten, das sehe ich euch doch an!\" sagte er dann mit langsamen Worten und l�chelte immernoch. \"Die G�tter w�rden euch sicher eine zweite Chance gew�hren, doch",0,50,3); 
             base.books.AddGermanBookText("was vermag ich zu tun? Ich bin ein gebrochener Mann, und au�er diesem Sand besitze ich nichts. Aber wisst ihr was? Ich schenke es euch, dann braucht ihr mich nicht zu bestehlen. Aber haltet fest an",0,50,3); 
             base.books.AddGermanBookText("eurer Absicht.\" sprach der Alte und nahm das Messer aus der Hand des Banditen. Dann griff er in seine eigene Tasche, zog etwas heraus und dr�ckte es in die Hand des jungen Diebes. Neugierig",0,50,3); 
             base.books.AddGermanBookText("�ffnete dieser seine Hand und im n�chsten Augenblick leuchtete ihm goldfarbener Sand entgegen, der im D�mmerlicht des Waldes wunderbar schimmerte. Wie gebannt von dem Anblick konnte er seine Augen",0,50,3); 
             base.books.AddGermanBookText("nicht l�sen. Doch pl�tzlich verbleichte der Sand und wurde zu schmutziger Erde, die durch seine Finger auf den Boden rieselte und verschwand. Ein kalter Wind fuhr durch den Wald und blies ihm die",0,50,3); 
             base.books.AddGermanBookText("Haare um die Ohren. In Gedanken wunderte er sich immernoch �ber die seltsamen Worte des blinden Mannes. Verst�ndnislos blickte er zu genau jenem. Jedenfalls wollte er zu dem Alten blicken, doch",0,50,3); 
             base.books.AddGermanBookText("der war verschwunden. Der Dieb stand ganz alleine im Wald auf einem kleinen Pfad, neben ihm auf dem Boden ein kleines Messer und ein H�ufchen Dreck, der durch seine Finger gerieselt war. Verwirrt",0,50,3); 
             base.books.AddGermanBookText("packte er sich an den Kopf, als wolle er �berpr�fen, ob er Fieber oder irgendeine schlimme Krankheit h�tte. Umso gr��er war der Schock, als er merkte, dass er sich mit der v�llig falschen Hand �ber",0,50,3); 
             ...
             base.books.AddGermanBookText("war es, mit der er sich �ber's Gesicht strich. Es war zweifelsfrei seine eigene.\n \nZu seinen F��en lag die Augenbinde des Alten, von ihm fehlt bis Heute jede Spur.",0,50,3); 
            ...
            base.books.AddGermanBookText( " seinen Nutzen mehren und sch�tzen, meinen Pflichten gewissenhaft nachkommen und Gerechtigkeit gegen jedermann �ben werde. ", 0, 0, 4 );
            base.books.AddGermanBookText( " Meine Macht endet an den Grenzen Silberbrands\" Tialdin, K�nig von Silberbrand ", 0, 0, 4 );   
            base.books.AddGermanBookText( " Lange ersehnt ist es nun Vollbracht die Zwerge haben ihren K�nig bestimmt. Nunmehr gibt es einen der sie leitet, der f�r sie streitet. ", 0, 0, 4 );   
            base.books.AddGermanBookText( " Somit soll nun und heute verk�ndet sein, welche Zwerge des Weiteren in Amt und W�rden gestellt seien. ", 0, 0, 4 );
            base.books.AddGermanBookText( " Unser Mitzwerg Rugosch wird seinen Platz finden an der Seite des K�nigs, er stehe f�r Belange des Glaubens an Irmorom den Gott der Zwerge,  ", 0, 0, 4 );   
            base.books.AddGermanBookText( " einem jeden der Rat suchet an der Seite, auch dem K�nig. ", 0, 0, 4 );   
            base.books.AddGermanBookText( " F�rderhin wird unser allseits bekannter und respektierter Mitzwerg Bombor in den Stand des Heroldes von Silberbrand bestellt. Er m�ge im Krieg und im Frieden unser Unterh�ndler sein. ", 0, 0, 4 );
            base.books.AddGermanBookText( " Seine Stimme wird den Willen des K�nigs allseits verk�nden. Seine Stimme ist die Stimme des K�nigs. ", 0, 0, 4 );     
            base.books.AddGermanBookText( " Des Weiteren wird der Klan der Axt unter der F�hrung ihres Selbstbestimmten Hauptmannes die Aufgaben der Garde �bernehmen. Wenn die Diplomatie versage werde er die Faust sein die unsere ", 0, 0, 4 );    
            base.books.AddGermanBookText( " Feinde zerschmettert. Er werde Straft�ter festsetzen und die Eing�nge bewachen, dass kein Unbill herein gelange nach Silberbrand. ", 0, 0, 4 );    
            base.books.AddGermanBookText( " Jeder Besucher hat sich den Anweisungen der Garde innerhalb unserer Hallen zu beugen. ", 0, 0, 4 );    
            base.books.AddGermanBookText( " Um der Verwirrung Einhalt zu gebieten, jeder Zwerg der es w�nsche und willens ist den B�rgereid von Silberbrand zu leisten, kann sich in die B�rgerrolle eintragen. ", 0, 0, 4 );    
            base.books.AddGermanBookText( " Jeder Zwerg sei uns in unseren Hallen willkommen.", 0, 0, 4 );     
            base.books.AddGermanBookText( " Die B�rgerrolle werde ausgelegt auf das sich jeder eintragen k�nne der den Eid als den seinen als geleistet betrachtet. ", 0, 0, 4 );    
            ...
            base.books.AddGermanBookText( " Es war viel Arbeit und M�he doch nunmehr ist es vollbracht.", 0, 0, 4 );    
			...
			base.books.AddGermanBookText("\n\n~~Topase~~",198,0,5);
            base.books.AddGermanBookText("Topasenergien von magischen Topasen haben wohl die unterschiedlichsten Wirkungen, abh�ngig davon, in welchen Gegenstand man ihre Energien flie�en l�sst.",0,0,5);
            base.books.AddGermanBookText("So werden magische Topase von fast allen Schichten gleicherma�en verwendet und gesch�tzt. Da sie zudem zu den seltensten Edelsteinen geh�ren, macht sie das gleichzeitig auch zu den wertvollsten.",0,0,5);
            ...
            base.books.AddGermanBookText("Zu beachten ist hierbei, dass man niemals die Energien eines Topases in ein Schmuckst�ck flie�en lassen sollte, in welches ein andersartiger Stein eingefasst wurde.",0,0,5);
			...
			base.books.AddGermanBookText("Ich muss euch warnen, dies Geschichte ist nicht f�r zartes Gem�t.\n Dieser Halbling kein gutes Leben f�hrte, und das unverbl�mt.\n \n",0,5,7);
			base.books.AddGermanBookText("In einem Stuhl sa� er also, frei von M�h und Plagen,\n Als herein durch die T�r kam seine Frau Annie, ihn zu fragen,\n",0,5,7);
			...
			base.books.AddGermanBookText("Mit Geschrei und Gel�chter, fing er an ihr zu gestehn.\n \"Oh, lustige Ehefrau! Diese Dinge waren l�ngst schon versehn!\"\n",0,5,7);
			base.books.AddGermanBookText("\"Die Fr�chte pfl�ckt ich letzte Woche schon, sie lagern im Keller.\"\n \"Und neue M�ntel beschafft ich auch, kostet'n sie auch manch teuren Heller!\"\n \n",0,5,7);
			base.books.AddGermanBookText("Er herzt sie und neckt sie, erkl�rt eifrig und viel.\n \"Nicht Bitternis noch K�lte wird diesen Herbst �ber dich zieh'n!\"\n",0,5,7);
			...
			base.books.AddGermanBookText("Jeder Halbling, ein jeder der m�hsam den R�cken zur Arbeit hatte geneigt,\n alle war'n, sogar der Barde, f�r den Winter bereit.\n",0,5,7);
			base.books.AddGermanBookText("Sie sa�en gem�tlich bei Brot und bei Wein,\n lie�en Arbeit und Erntemonat und F�nfe gerade sein.\n \n",0,5,7);
			...
			base.books.AddGermanBookText("Brewyn sank auf die Knie, die Augen mit Tr�nen gef�llt.\n Als vom Himmel hinabflog eine Fee, s��e Stimme in ein Liedchen geh�llt:\n \n",0,5,7);
			base.books.AddGermanBookText("\"Bitte h�r mich an H�bscher, w�hrend ich dich umschwirr,\n als Fee, so schw�r ich, zeig ich einen Weg dir aus deinem Gewirr.\"\n",0,5,7);
			...
			base.books.AddGermanBookText("\"Ei! Ich h�tt's dies Jahr schon erledigt!\" rief er aus laut und schlau.\n \"W�rst du mir als Aufhalt nicht dazwischen gekommen, ja das wei� ich genau!\"\n",0,5,7);
			base.books.AddGermanBookText("B�sen Blick ihm die Fee im Abflug mitgab.\n \"Diese L�ge hat dir geschaufelt dein eigenes Grab.\"\n \n",0,5,7);
			base.books.AddGermanBookText("Brewyn zog mutlos zur�ck zu seinem Haus in dem H�gel,\n Annie hatte Recht, f�r den Winter blieb ihnen kein einziger Kr�mel.\n",0,5,7);
			base.books.AddGermanBookText("Zur�ck sich der L�gner in seinen Sessel verzog,\n der Bedauernswerte sich und seine F��e mit Komfort und falscher Sicherheit belog.\n \n",0,5,7);
			...
			base.books.AddGermanBookText("Denn ohne Brennholz im Haus, legte K�lte sich �ber erloschenes Feuer\n Und in seinem Sessel erfroren sa� Brewyn, dem die Wahrheit nicht teuer.\n",0,5,7);
			----------------------------------------------
  ...
  function LookAtItem(User,Item) 
      if base.books.InitTitle() then 
          ...
          base.books.AddGermanBookTitle( "Buch mit dem Titel \" Tialdins Gel�bnis \"", 4 );
          ...
          base.books.AddGermanBookTitle("Buch mit dem Titel \"Gebet f�r Zelphia\"",6);
          
		  base.books.AddEnglishBookTitle("Book with the title \"Brewyn the Liar\"",7);
		  base.books.AddGermanBookTitle("Buch mit dem Titel \"Brewyn der L�gner\"",7);
      end 
