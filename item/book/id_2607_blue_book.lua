...
function M.UseItem(User, SourceItem, TargetItem, Counter, Param) 
      if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then 
          ...
          if base_books.InitBook() then 
            ...
            base_books.AddEnglishBookText("The Elder Gods",0,0,0); 
            base_books.AddEnglishBookText("The Elder Gods were a group of five who have created this world. Their reasons are shrouded in mystery though.",0,0,0); 
            base_books.AddEnglishBookText("Bragon is the Elder God of Fire. He is rumored to be very extravagant and has a love for gold. He is said to be strong, just, and noble. ",0,0,0); 
            base_books.AddEnglishBookText("Eldan is the Elder God of Spirit. He is considered to be very wise and has very few followers. He wasn't known as active amoungst mortals, a possible reason for his scarce followers.",0,0,0); 
            base_books.AddEnglishBookText("Findari is the Elder Goddess of Air. She is very creative and therefore relatable to the arts. Her followers are rare as well, though they tend to be prophets and bards.",0,0,0); 
            base_books.AddEnglishBookText("Tanora is the Elder Goddess of Water. She is is considered the mother of lizardmen and is known as Zelphia to them. She is the only Elder God to possibly be active amoung mortals.",0,0,0); 
            base_books.AddEnglishBookText("Ushara is the Elder Goddess of Earth. She is said to reject any form of wealth and her altars are the earth itself.",0,0,0); 
            base_books.AddEnglishBookText("The Younger Gods",0,0,0); 
            base_books.AddEnglishBookText("The Younger Gods were eleven outstanding citizens that were altered to become Gods, selected by the Elder Gods.",0,0,0); 
            base_books.AddEnglishBookText("Elara is the Goddess of Knowledge. She is often worshipped by mages and scholars. She is rumored to prefer the life of a hermit, and sometimes appears as a tall ageless female.",0,0,0); 
            ...
            base_books.AddEnglishBookText("Zhambra is the God of Friendship and Loyalty. He is said to appear as a young noble who is very sympathetic, until he is betrayed. He does not stand for such things.",0,0,0); 
            ...
            base_books.AddEnglishBookText("Halflings, to the ignorant, look like children of humans and indeed their appearance is similar to such associations.",0,0,1);
            base_books.AddEnglishBookText("They most signifigant difference besides their small height are their big and hairy feet, which they proudly present to the public. They tend to live longer than humans.",0,0,1);
            base_books.AddEnglishBookText("Halflings prefer to live in areas dominated by hills and thin forests, where they dig their homes into the earth. Over the generations, these caverns can obtain quite a respectable size.",0,0,1);
            base_books.AddEnglishBookText("Their houses are filled with much furniture and other belongings, for halflings will rarely throw anything away. They tend to find houses other then theirs to be uncomfortable.",0,0,1);
            base_books.AddEnglishBookText("In their homes, they live with large family clans led by a clan chief. This is an honorary title rather than an actual position of power. The function of this position is to organize family events.",0,0,1);
            base_books.AddEnglishBookText("Halflings usually show up to dinner uninvited and must leave with a full stomach, any other way would be impolite. Malicious tongues say that three things are most importan to halflings.",0,0,1);
            base_books.AddEnglishBookText("These are breakfast lunch and dinner!",0,0,1);
            base_books.AddEnglishBookText("Though, they do take serious interest in food in drinks. They are notorious for their sweet tooth. One may often find themselves being lectured by a halfling on the finer parts of cooking.",0,0,1);
            base_books.AddEnglishBookText("In fact, it is common for a tavern to boast that their cook is a halfling.",0,0,1);
            base_books.AddEnglishBookText("Halflings prefer to earn a living from the earth. There are actually some who have become well known for their mastery in handcrafts, but they are generally farmers, hunters, and herbalists.",0,0,1);
            base_books.AddEnglishBookText("In towns, there are often small shrines to Oldra. In fact, their harvest festival is their most important holiday throughout the entire year.",0,0,1);
            base_books.AddEnglishBookText("Living in nature for a while, they have developed a great skill to move nimbly and with little sound. While many won't admit it, most of these skills are used for petty thievery.",0,0,1);
            base_books.AddEnglishBookText("It would be wise to watch halflings that are adorned with symbols of Ronagan, they might mean business around you.",0,0,1);
            base_books.AddEnglishBookText("Halflings have an easy approach to life. They seldom worry about the future and its outcomes, instead they prefer resting and long chats with old friends.",0,0,1);
            base_books.AddEnglishBookText("They do not have a sense for ranks, but highly value the importance of family and friends. This is seen throughout their society and its structure, usually they are loose and dominated by halflings.",0,0,1)
            base_books.AddEnglishBookText("Their childlike appearance may be mistaken as being defenceless. They are very hard to anger, unless you begin to toy with their food of course.",0,0,1);
            base_books.AddEnglishBookText("They are very determined as well, and one would not want to be in the way of a halfling if he has set his path already. Orcs and Humans have learned this the hard way.",0,0,1);
            ...
            base_books.AddLanguage("dwarf language",2);
            base_books.AddEnglishBookText( " Since the orc wars, the dwarves lived spread widely amongst the countries, but they always sticked to their belief and their traditions. ", 0, 0, 2 );
            ...
            base_books.AddEnglishBookText( " And so the elders of the two different tribes came together and spoke to the couple: 'You may marry and bring the tribes together here, the day, that this place gives gemstones again!' ", 0, 0, 2 ); 
            base_books.AddEnglishBookText( " That made Irmorom thoughfully, but he open for helping the couple and so he let the mine spit out as many gold and gemstones, as one could ever imagine. ", 0, 0, 2 );
            base_books.AddEnglishBookText( " But when the couple returned to the elders, telling them the good news, greed inflamed in the elders' eyes. ", 0, 0, 2 );
            base_books.AddEnglishBookText( " Without even thinking about the wedding, they went to the mine to carry out all the gems and the gold. ", 0, 0, 2 ); 
            base_books.AddEnglishBookText( " That made Irmorom so angry, that he personally came down from his mountain, appearing under the dwarves as the old longbeard, he had been seen as, often before. ", 0, 0, 2 );
            base_books.AddEnglishBookText( " He raises his voice and said to the elders: 'Look at you, you that call yourselves the wise and noble ones. ", 0, 0, 2 );  
            base_books.AddEnglishBookText( " You should be ashame to feed your greed while your king longs for the love of a warrior, that could end all your problems.' ", 0, 0, 2 );
            base_books.AddEnglishBookText( " But they didn't listen to him, because their greed had made them blind and deaf, so that they didn't recognize him. ", 0, 0, 2 ); 
  ...
  function LookAtItem(User,Item) 
      if base_books.InitTitle() then 
        ...
        base_books.AddEnglishBookTitle( "Book with the title \" The Festival Of Relationship \"", 2 );
        base_books.AddGermanBookTitle( "Buch mit dem Titel \" Das Fest der Bindung \"", 2 );

		base_books.AddEnglishBookTitle("Book with the title \"Bluestones\"",3);
        base_books.AddGermanBookTitle("Buch mit dem Titel \"Blausteine\"",3);
