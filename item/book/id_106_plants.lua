...
function M.UseItem(User, SourceItem, TargetItem, Counter, Param)
  if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
    ...
    if base_books.InitBook() then
       ...
       base_books.AddGermanBookText("Die W�stenhimmelskapsel wird in W�sten gefunden. Sie wird dazu gebraucht, das Element Wind zu verwenden.",0,0,0);
       base_books.AddGermanBookText("Das Donfblatt w�chst im Wald. Es wird angeblich benutzt, um irgend etwas zusammenzukleben.",0,0,0);
       base_books.AddGermanBookText("Sandbeeren verst�rken den Effekt von Zaubertr�nken. Man sagt, sie seien in der W�ste zu finden.",0,0,0);
       base_books.AddGermanBookText("Wutbeeren k�nnen in Hecken tief im Wald gefunden werden.",0,0,0);
       base_books.AddGermanBookText("Wenn man eine Tanne pflanzen will, braucht man zuerst einen Tannensetzling.",0,0,0);
       base_books.AddGermanBookText("Tannensetzlinge k�nnen von Tannen abgeschnitten werden.",0,0,0);
       base_books.AddGermanBookText("�pfel verrotten nach eienr Weile. Wenn man sie gut w�ssert, w�chst daraus erneut ein Setzling.",0,0,0);
       base_books.AddGermanBookText("Beeren wachsen an B�schen im Wald.",0,0,0);
       base_books.AddGermanBookText("Zwiebeln gedeihen auf Ackerboden.",0,0,0);
       base_books.AddGermanBookText("Tomaten wachsen an B�schen, wenn man vorher die Erde beackert.",0,0,0);
       base_books.AddGermanBookText("Kirschen verrotten nach einiger Zeit. W�ssert man sie stattdessen gut, k�nnen daraus Setzlinge wachsen.",0,0,0);
       base_books.AddGermanBookText("Wenn man die Wurzeln einer Tanne ausgr�bt, kann man dort eine geheime Pflanze finden.",0,0,0);
       base_books.AddGermanBookText("Gutes Getreide braucht gute Samen und eine fruchtbare Erde.",0,0,0);
       base_books.AddGermanBookText("Der Bl�tterpilz findet sich in der N�he von Tannen.",0,0,0);
       base_books.AddGermanBookText("Die Firnisbl�te gedeiht auf Wiesen nahe an Bachl�ufen besonders gut.",0,0,0);
       base_books.AddGermanBookText("Der gut schmechende Rotkopfpilz kann in W�ldern gefundenwerden.",0,0,0);
       base_books.AddGermanBookText("Ein Kirschbaum wird mit seinen Wurzeln gef�llt.",0,0,0);
       base_books.AddGermanBookText("Eine Palme wird mit ihren Wurzeln gef�llt.",0,0,0);
       base_books.AddGermanBookText("Man sollte nie versuchen, B�ume zu f�llen, wenn man Schilde tr�gt.",0,0,0);
       base_books.AddGermanBookText("In Schilfg�rteln nahe an saftigen Wiesen kann die Vierbl�ttrige Einbeere von wachsamen Augen gefunden werden.",0,0,0);
       base_books.AddGermanBookText("Das Gelbe Kraut ist eine wiederkehrende Pflanze in Wiesen.",0,0,0);
       base_books.AddGermanBookText("In den tiefsten W�ldern wartet die Flammenkelchbl�te darauf gepfl�ckt zu werden.",0,0,0);
       base_books.AddGermanBookText("Wenn Engel weinen, lassen ihre Tr�nen Nachtengelsbl�ten im Dreck wachsen.",0,0,0);
       base_books.AddGermanBookText("Das Heidekraut braucht nie Regen. Wenige Tropfen des morgendlichen Taus auf einem sandigen H�gel sind genug f�r diese gen�gsame Pflanze.",0,0,0);
       base_books.AddGermanBookText("Das Fu�blatt ist der einzige Farn, der keinen sandigen Untergrund im Sinn hat.",0,0,0);
       base_books.AddGermanBookText("Grabe mit deiner Hand im Dreck und finde einige Sibanac Bl�tter im Schilf.",0,0,0);
       base_books.AddGermanBookText("Wo Kulturland in Steppe �bergeht, findet sich ein von den meisten Leuten �bersehener Farn.",0,0,0);
       base_books.AddGermanBookText("Einige �ltere Palmen verbergen verrottete Rinde an ihren Baumwurzeln.",0,0,0);
       base_books.AddGermanBookText("Der Hirtenpilz lebt in Symbiose mit Fruchtb�umen und liebt schattige Pl�tze in der N�he des Waldes.",0,0,0);
       base_books.AddGermanBookText("Der Geburtspilz kann an Nadelwaldr�ndern gefunden werden.",0,0,0);
