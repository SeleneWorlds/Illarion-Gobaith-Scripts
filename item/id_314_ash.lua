...
function M.LookAtItem(User,Item)
    ...
    elseif ( Item.quality == 231 ) then --Ghostskeleton
        if (User:getPlayerLanguage() == 0) then
            world:itemInform(User,Item,"Du siehst bl�uliche Asche");
        else
