...
function M.loadBook(toData)
    ...
    base_books.AddEnglishBookText("Be it the archer, the mounted envoy or the mariner - Everyone who wants the winds on his side uses the energies of amethysts.",0,0,toData);
    base_books.AddEnglishBookText("If you carry an object with amethyst energies flowing in it, you feel as if everything you start is carried out faster.",0,0,toData);
...
function M.loadTitle(toData)
    base_books.AddEnglishBookTitle("Book with the title \"Amethyst\"",toData);
    base_books.AddGermanBookTitle("Buch mit dem Titel \"Amethysten\"",toData);
end;
