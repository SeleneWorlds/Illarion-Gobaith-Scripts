...
function M.loadBook(toData)
    ...
    base_books.AddEnglishBookText("The green of emeralds often reminds of the fresh green of a spring meadow or a summerforest. It is therefore not too surprising that these stones are likely to be used by poeple with a close bond to nature.",0,0,toData);
    base_books.AddEnglishBookText("The powers of magic emeralds are different, depending on the object they are attached to. It is said that they can help in sharpening the bearer's senses in order to provide a better perception.",0,0,toData);
    base_books.AddEnglishBookText("Weapons: Emerald energies flowing through a weapon can provide a better aim. This is very helpful not only for distance weapons.",2780,0,toData);
    base_books.AddEnglishBookText("Armor and Shields: Used on Armor or Shielding, emerald powers can protect from piercing damage.",20,0,toData);
    base_books.AddEnglishBookText("Magic Wands: Emerald energies can bundle the bearer's powers and therefore enable a higher casting range.",76,0,toData);
    base_books.AddEnglishBookText("Tools: If one uses emerald power on tools, a higher durability of the items crafted by the tool can be achieved.",172,0,toData);
    base_books.AddEnglishBookText("Trinkets: If you bear a trinket with the energy of an emerald, you will be able to percept your surrounding better.",62,0,toData);
...
function M.loadTitle(toData)
    base_books.AddEnglishBookTitle("Book with the title \"Emeralds\"",toData);
    base_books.AddGermanBookTitle("Buch mit dem Titel \"Smaragde\"",toData);
end;
