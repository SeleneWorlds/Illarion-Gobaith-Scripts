...
function M.UseItem(User, SourceItem, TargetItem, Counter, Param, ltstate)
      if base.books.InitBook() then
        ...
        base.books.AddGermanBookText("Druiden sind Heiler, Besch�tzer der Natur und Freunde allen Lebens.",0,0,0);
        base.books.AddGermanBookText("Gefahr! Bier - vor allem das von Zwergen gebraut wurde - vertr�gt nicht jeder.",0,0,0);
        base.books.AddGermanBookText("Einige glauben, dass der legend�re Seher und Heiler Nifrindarai der Begr�nder des Druidentums war.",0,0,0);
        base.books.AddGermanBookText("Einige Lehren berichten von geheimer Zauberkunst, die Druiden Macht �ber die Natur gibt.",0,0,0);
        base.books.AddGermanBookText("Einige Pilze wachsen am besten im Kompost.",0,0,0);
        base.books.AddGermanBookText("Jede lebende und unbelebte Kreatur existiert nur durch die Vermischung der f�nf Urspr�nge.",0,0,0);
        ...
        base.books.AddGermanBookText("Ein Druide ist immer freundlich, was sich in seiner liebensw�rdigen Art ausdr�ckt.",0,0,0);
        base.books.AddGermanBookText("Einen Druiden zu bedrohen, kann gro�e Gefahr ausl�sen. Gew�hnlich friedfertig, wissen Druiden nicht nur zu heilen, sondern kennen auch die Kunst der Zerst�rung.",0,0,0);
        base.books.AddGermanBookText("Sich in einem immerw�hrenden Fluss befindend, versammelt, verschmilzt und zerfliesst die Welt st�ndig.",0,0,0);
        base.books.AddGermanBookText("In der Anfangszeit des Druidenzirkels der W�lder musste er die Ignoranten z�geln, die sich weigerten an ein friedfertiges Leben zu glauben.",0,0,0);
        base.books.AddGermanBookText("Druiden sind oft auch Alchemisten!",0,0,0);
        base.books.AddGermanBookText("Um Tinte zu machen, braucht man eine mineralische Komponente, eine verd�nnende und eine botanische Komponente.",0,0,0);
        ...
        base.books.AddGermanBookText("Das wichtigste Requisit des Alchemisten ist ein guter Kupferkessel, jeder Druide besitzt seinen eigenen Kochtopf, von dem er sich nie, nie im Leben trennen w�rde.",0,0,0);
        base.books.AddGermanBookText("Dann braucht man nat�rlich etwas, um die Essenzen aus den Pflanzen aufzufangen - also jede Menge leerer Flaschen.",0,0,0);
        base.books.AddGermanBookText("Und schlussendlich braucht man, wen wundert's, einen reichen Vorrat an Pflanzen.",0,0,0);
        base.books.AddGermanBookText("Wer nicht selbst hinausgeht und sich die H�nde schmutzig macht, der sollte beim Kauf auf Qualit�t achten. Aus schlechten Pflanzen wird selten ein guter Trank.",0,0,0);
        base.books.AddGermanBookText("Hat man seine sieben Sachen beieinander, kanns endlich losgehen. Jetzt hei�t es, Geduld bewahren.",0,0,0);
        base.books.AddGermanBookText("Mit der leeren Flasche in der einen und einem ben�tigten Kr�utlein in der anderen Hand, sollte einem bei Benutzung des Kupferkessels bald ein erster Erfolg beschieden sein.",0,0,0);
        base.books.AddGermanBookText("Auch wenn man vielleicht anfangs nicht viel sieht, die erste Flasche mit Essenzen sollte auch noch eine Zeitlang mit Pflanzens�ften gef�llt werden, bald schon wird sich das erwartete Ereignis einstellen.",0,0,0);
        base.books.AddGermanBookText("Wer Geduld hat und flei�ig sein Fl�schlein f�llt, den wird der Geist der Druiden bald umgeben, schau in dein Runenverzeichnis, jetzt bist du ein Mitglied im druidischen Zirkel.",0,0,0);
        base.books.AddGermanBookText("Wer dort jedoch sieht, dass ihm die G�tter bereits Runen des Magiers, des Barden oder gar des Priesters geschenkt haben, dem bleiben die Pforten der Druiden verschlossen, vielleicht auf ewig.",0,0,0);
        base.books.AddGermanBookText("\nDie erste Rune",0,0,0);
        base.books.AddGermanBookText("Was kann man nun aber mit der ersten druidischen Rune anstellen? Nun, mit ihr lassen sich Pflanzen nach ihren Inhaltsstoffen bestimmen. Nichts Spektakul�res, wie etwa ein Unsichtbarkeitstrank, aber f�r die weitere Laufbahn als Druide sehr sehr n�tzlich.",0,0,0);
