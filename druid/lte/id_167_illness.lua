...
--    K�rper drehen, Schritte machen
	  ...
	  if Runde - (math.floor(Runde/30)*30) == 0 then
		if paranoiaList == nil then
			...
			paranoiaList[1][7] = "Eine dunkle Wolke bildet sich direkt �ber deinen Kopf. Spannung liegt in der Luft. Mit einem Mal schie�en Blitze aus der Wolke und treffen den Boden um dich herum. Flieh, bevor du zu Asche wirst!";
