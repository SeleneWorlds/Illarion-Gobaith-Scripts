...
function M.enemyNear(Monster,Enemy)
    ...
    if (MonID==253) then
        return ( drop.CastMonMagic(Monster,Enemy,5,{1000,3000},{{4,5},{9,5},{51,5}},{},40,1) == true );
    elseif (MonID==254) then
...
function M.onDeath(Monster)
    ...
    if (MonID==251) then --Gnoll, Level: 6, Armourtype: light, Weapontype: slashing
        ...
        if not done then done=drop.AddDropItem(96,1,10,(100*math.random(5,6)+math.random(55,66)),0,1); end --steel tower shield
        if not done then done=drop.AddDropItem(48,1,1,(100*math.random(5,6)+math.random(55,66)),0,1); end --leather gloves
        ...
        local done=drop.AddDropItem(552,1,20,(100*math.random(5,6)+math.random(55,66)),0,2); --deer meat
        if not done then done=drop.AddDropItem(307,1,10,(100*math.random(5,6)+math.random(55,66)),0,2); end --pork
        if not done then done=drop.AddDropItem(553,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --rabbit meat
        if not done then done=drop.AddDropItem(2940,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --steak
        if not done then done=drop.AddDropItem(2934,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --lamb meat

        --Category 3: Weapon

        local done=drop.AddDropItem(25,1,20,(100*math.random(5,6)+math.random(55,66)),0,3); --sabre
        if not done then done=drop.AddDropItem(78,1,10,(100*math.random(5,6)+math.random(55,66)),0,3); end --short sword
        if not done then done=drop.AddDropItem(2694,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --poisoned serinjahsword
        if not done then done=drop.AddDropItem(1,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --serinjahsword
    ...
    elseif (MonID==252) then --Gnoll Warrior, Level: 6, Armourtype: light, Weapontype: slashing
        ...
        if not done then done=drop.AddDropItem(916,1,10,(100*math.random(5,6)+math.random(55,66)),0,1); end --ornate tower shield
        ...
        if not done then done=drop.AddDropItem(2547,1,10,(100*math.random(5,6)+math.random(55,66)),0,2); end --leather
        if not done then done=drop.AddDropItem(2746,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --razor blade
        if not done then done=drop.AddDropItem(47,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --needle
        if not done then done=drop.AddDropItem(50,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --thread

        --Category 3: Weapon

        local done=drop.AddDropItem(2757,1,20,(100*math.random(5,6)+math.random(55,66)),0,3); --scimitar
        if not done then done=drop.AddDropItem(2701,1,10,(100*math.random(5,6)+math.random(55,66)),0,3); end --longsword
        if not done then done=drop.AddDropItem(2658,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --broad sword
    ...
    elseif (MonID==253) then --Gnoll Shaman, Level: 6, Armourtype: cloth, Weapontype: concussion
        ...
        if not done then done=drop.AddDropItem(1001,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --plate
    ...
    elseif (MonID==254) then --Gnoll Thief, Level: 5, Armourtype: light, Weapontype: puncture
        ...
        local done=drop.AddDropItem(2113,1,20,(100*math.random(4,5)+math.random(44,55)),0,1); --fur trousers
        ...
        if not done then done=drop.AddDropItem(83,1,10,(100*math.random(4,5)+math.random(44,55)),0,2); end --topaz amulet
        if not done then done=drop.AddDropItem(282,1,1,(100*math.random(4,5)+math.random(44,55)),0,2); end --topaz ring
        if not done then done=drop.AddDropItem(257,1,1,(100*math.random(4,5)+math.random(44,55)),0,2); end --raw topaz
        if not done then done=drop.AddDropItem(1858,1,1,(100*math.random(4,5)+math.random(44,55)),0,2); end --goblet

        --Category 3: Weapon

        local done=drop.AddDropItem(2740,1,20,(100*math.random(4,5)+math.random(44,55)),0,3); --red dagger
        if not done then done=drop.AddDropItem(2675,1,10,(100*math.random(4,5)+math.random(44,55)),0,3); end --rapier
        if not done then done=drop.AddDropItem(2689,1,1,(100*math.random(4,5)+math.random(44,55)),0,3); end --poisoned ornate dagger
    ...
    elseif (MonID==255) then --Gnoll Forester, Level: 6, Armourtype: light, Weapontype: distance
        ...
        if not done then done=drop.AddDropItem(2935,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --soup bowl
        if not done then done=drop.AddDropItem(63,1,1,(100*math.random(5,6)+math.random(55,66)),0,2); end --entrails
        ...
        if not done then done=drop.AddDropItem(2714,1,10,(100*math.random(5,6)+math.random(55,66)),0,3); end --hunting bow
        if not done then done=drop.AddDropItem(2727,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --serinjah firebow
        if not done then done=drop.AddDropItem(2646,1,1,(100*math.random(5,6)+math.random(55,66)),0,3); end --serinjah rider bow
