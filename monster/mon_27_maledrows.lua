...
msgs:addMessage("#me f�hrt mit einer Hand durch sein Haar, ein grausames Grinsen liegt auf seinem Gesicht.", "#me runs a hand through his hair, a cruel smirk covering his face.");
msgs:addMessage("#me fasst seine Waffe fester.", "#me tightly grips his weapon.");
msgs:addMessage("#me schlie�t seine Augen und beginnt wie wahnsinnig zu lachen.", "#me closes his eyes and begins to laugh maniacally.");
...
msgs:addMessage("Br�der! Lasst uns Jagd auf die Schwachen machen.", "Brothers! Let us prey upon the weak.");
...
function M.onDeath(Monster)
    ...
    elseif (MonID==272) then --Drow Warrior, Level: 6, Armourtype: medium, Weapontype: slashing
    ...
    elseif (MonID==273) then --Drow Mage, Level: 6, Armourtype: cloth, Weapontype: concussion
    ...
    elseif (MonID==274) then --Drow Priest, Level: 6, Armourtype: cloth, Weapontype: concussion
    ...
    elseif (MonID==275) then --Drow Patriarch, Level: 6, Armourtype: heavy, Weapontype: slashing
