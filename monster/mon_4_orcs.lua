...
function enemyOnSight(Monster,Enemy)
    ...
    elseif (MonID==45) then
        return ( monster.base.drop.CastMonMagic(Monster,Enemy,5,{1500,2000},{{51,5}},{},40,1,{50,60}) or monster.base.drop.CastHealing( Monster, 5, {2000,3500}, 8, {16, 13}, 40 ) );
    else
        return false
    end
end
...
function onDeath(Monster)
    ...
    local MonID=Monster:get_mon_type();
        ...
        if not done then done=monster.base.drop.AddDropItem(2286,1,10,(100*math.random(4,5)+math.random(44,55)),0,1); end --flame helmet
