...
M.Script = "m_02_11_16_23_24_firewall.lua";
...
M.Settings = {
    ["Runes"] = "RA IRA ANTH DUN QWAN",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
