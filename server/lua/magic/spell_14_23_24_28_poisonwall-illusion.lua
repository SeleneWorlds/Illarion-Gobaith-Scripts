...
M.Script = "m_14_23_24_28_poisonwall-illusion.lua";
...
M.Settings = {
    ["Runes"] = "LOHR YEG ANTH DUN",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
