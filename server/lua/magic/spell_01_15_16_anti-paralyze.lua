...
M.Script = "m_01_15_16_anti-paralyze.lua";
...
M.Settings = {
    ["Runes"] = "KEL JUS QWAN",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
...
M.TimeEffects = {
    ...
    ["msg"] = {             -- The messages that are shown before the time delay is started in german and english
        [CPlayer.german ] = "#me beginnt mit einer mystischen Formel und um {PP}n F��e beginnt etwas leichter und loser Dreck vom Boden zu wirbeln.",
        [CPlayer.english] = "#me starts with a mystical formula and around {PP} feet some light and loose dirt whirls."
    }
}
...
M.CasterEffects = {
    ...
    ["maxSkill"] = {                -- effects that are caused in case the caster has the maximum needed skill
        ["hitpoints"]    =     0,   -- increase of the hitpoints
        ["foodpoints"]   =     0,   -- increase of the foodlevel
        ["actionpoints"] =    -4,   -- increase of the action points
