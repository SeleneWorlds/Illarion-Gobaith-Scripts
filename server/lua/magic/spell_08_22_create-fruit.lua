...
M.Script = "m_08_22_create-fruit.lua";
...
M.Settings = {
    ["Runes"] = "ORL KAH",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
...
M.CasterEffects = {
    ["minSkill"] = {                -- effects that are caused in case the caster has to minimum needed skill
        ...
        ["foodpoints"]   =  1000,   -- increase of the foodlevel
    ...
    ["maxSkill"] = {                -- effects that are caused in case the caster has the maximum needed skill
        ["hitpoints"]    =     0,   -- increase of the hitpoints
        ["foodpoints"]   = 12000,   -- increase of the foodlevel
