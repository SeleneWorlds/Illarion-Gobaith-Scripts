...
M.Script = "m_02_13_23_24_28_firecircle-illusion.lua";
...
M.Settings = {
    ["Runes"] = "LHOR HEPT ANTH DUN SAV",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
...
M.Circle = {
    ["gfx"] = 4,                -- gfx shown in case a item is created on this spot
    ["sfx"] = 5,                -- sfx played in case a item is created on this spot
