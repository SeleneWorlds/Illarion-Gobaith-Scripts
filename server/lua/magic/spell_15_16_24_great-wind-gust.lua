...
M.Script = "m_15_16_24_great-wind-gust.lua";
...
M.Settings = {
    ["Runes"] = "JUS DUN QWAN",   -- Names of the runes the spell contains of. This is the text spoken when the spell is casted
    ["Range"] = 8,          -- Maximum distance in tiles between the target of the spell and the caster
    ["AllInLine"] = true  -- Perform a line of flight calculation and hit the first character on this line or the destination the caster pointed at
}
...
M.SpellEffects = {
    ...
    [1] = {                 -- Radius 1 around the target location
        ...
        ["sfx"] = 4         -- Sound effect that is placed on radius 1
    },
    [2] = {                 -- Radius 2 around the target location
        ["gfx"] = 7,        -- Grafic effect that is shown on radius 2
        ["sfx"] = 4         -- Sound effect that is placed on radius 2
    }
}
...
M.TimeEffects = {
    ...
    ["msg"] = {             -- The messages that are shown before the time delay is started in german and english
        [CPlayer.german ] = "#me beginnt mit einer mystischen Formel und um {PP} F��e beginnt Dreck und Staub vom Boden zu wirbeln.",
        [CPlayer.english] = "#me starts with a mystical formula and around {PP} feet dirt and dust from the ground start to whirl."
    }
}
...
M.TargetEffects = {
    ["minSkill"] = {                -- effects that are caused in case the caster has the minium needed skill
        ...
        ["poison"]       =     0,    -- increase of the poison value
        ["posoffset"]    =     1    -- change the position of the character by this value from the caster away
    },
    ["maxSkill"] = {                -- effects that are caused in case the caster has the maximum needed skill, however the needed Skill is higher then the the setted value due the magic resistance
        ["hitpoints"]    =     0,   -- increase of the hitpoints
        ["foodpoints"]   =     0,   -- increase of the foodlevel
        ["actionpoints"] =   -50,   -- increase of the action points
        ["manapoints"]   =     0,   -- increase of the mana
        ["poison"]       =     0,    -- increase of the poison value
        ["posoffset"]    =     4    -- change the position of the character by this value from the caster away
    }
}
