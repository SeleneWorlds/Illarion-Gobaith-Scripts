...
--User:inform("debug 129-4")
   if base_books.InitTitle() then
      base_books.AddGermanBookTitle("Buch mit dem Titel \"Brief an die Druiden\"",0);
      base_books.AddEnglishBookTitle("Book with the title \"Letter for the druids\"",0);
   end
