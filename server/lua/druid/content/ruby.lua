...
function M.loadBook(toData)
    ...
    base_books.AddEnglishBookText("The red colour of rubys is admired and appreciated by warriors and followers of the flame of irmorom in the same measure. Warriors believe that the power of rubys can raise their fighting skills.",0,0,toData);
    base_books.AddEnglishBookText("Followers of Irmorom, on the other hand, are confident that rubys can enhance their crafting skills.",0,0,toData);
...
function M.loadTitle(toData)
    base_books.AddEnglishBookTitle("Book with the title \"Ruby\"",toData);
    base_books.AddGermanBookTitle("Buch mit dem Titel \"Rubine\"",toData);
end;
