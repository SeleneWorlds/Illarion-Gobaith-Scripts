...
function M.CastMagicOnCharacter(User, TargetCharacter, Counter, Param)
    ...
    log.Write(User, User.name .. "(" .. User.id .. ") changed race of " .. TargetCharacter.name .. "(" .. TargetCharacter.id .. ") from " .. oldRace .. " to " .. value);
end
