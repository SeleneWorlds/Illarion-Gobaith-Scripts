...
function MoveToField(Character)
	...
	if Character:getQuestProgress(2) < 20 and not Character:isAdmin() then
		...
		common.TempInformNLS(Character,
			"Du hast die ersten Lektionen noch nicht absolviert. Gehe den Weg zur�ck zum Hafen und spreche den Menschen Henry an. Wenn du fertig bist, wird er dich weiterschicken.",
	...
	elseif (not Character:isAdmin() ) then
		common.TempInformNLS(Character,
			"Siehst du den Gnom dort vorn? Vielleicht solltest du zu ihm gehen und 'Hallo' sagen. Wenn du einem NPC begegnest, dann gr��e ihn einfach, um ein Gespr�ch zu beginnen.",
