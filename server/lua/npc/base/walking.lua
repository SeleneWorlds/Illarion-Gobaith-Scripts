...
function M.BW_OneStepToPosition( Character, TargetPos )
...
function M.BW_StepAlongRoad( Character )
...
function M.BW_intern_MoveX(Character,XOff,forced)
...
function M.BW_intern_MoveY(Character,YOff,forced)
...
function M.BW_intern_IDinList( id , lower, upper, list )
    if lower > upper then
        return false;
    end;
...
function M.BW_intern_pos_okay( posi )
