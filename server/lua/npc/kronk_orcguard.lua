...
function M.initializeNpc()
    ...
    autonpcfunctions.AddAdditionalText("Goodbyes."); 
  	...
  	autonpcfunctions.AddTraderTrigger("[Ww]hat.+[Nn]ame", "Meh "..thisNPC.name.."! Meh jailer ob orc caves!"); 
  	autonpcfunctions.AddTraderTrigger("[Ww]hub.+[Nn]ame", "Meh "..thisNPC.name.."! Meh jailer ob orc caves!"); 
  	...
  	autonpcfunctions.AddTraderTrigger("[Ww]hat.+[Yy]o.*do",""..thisNPC.name.." opens and closes jail! Yoo wunt get in or out? Den tell meh keyword"); 
