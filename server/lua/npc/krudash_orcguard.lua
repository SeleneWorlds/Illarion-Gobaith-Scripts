...
function M.initializeNpc()
    ...
    autonpcfunctions.AddAdditionalText("Grubas!"); 
    autonpcfunctions.AddTraderTrigger("[Aa]uf [Bb]ald","Farebas."); 
    ...
    autonpcfunctions.AddTraderTrigger("[Ww]er [bs][ie][si][td] [di][uh].*","Mir Gefängniswärter für Orktor! Keine Ratte hier rein kommen ohne dass "..thisNPC.name.." merken!"); 
    ...
    autonpcfunctions.AddTraderTrigger("[Ww]as.+[Mm]ach.*t",""..thisNPC.name.." öffnen und schließen Gefängnis! Du wollen rein oder raus? Dann du mir sagen Losungswort!"); 
    ...
    autonpcfunctions.AddAdditionalText("Goodbyes."); 
  	autonpcfunctions.AddTraderTrigger("[Ww]ho.+yo.+","Meh beh "..thisNPC.name..", nub single rat whub enterr orc embassy witout meh sees it!"); 
  	autonpcfunctions.AddTraderTrigger("[Ww]hat.+[Nn]ame", "Meh "..thisNPC.name.."! Meh guard ob orc embassy!"); 
  	autonpcfunctions.AddTraderTrigger("[Ww]hub.+[Nn]ame", "Meh "..thisNPC.name.."! Meh guard ob orc embassy!"); 
  	...
  	autonpcfunctions.AddTraderTrigger("[Ww]hat.+[Yy]o.*do",""..thisNPC.name.." opens and closes embassy! Yoo wunt get in or out? Den tell meh keyword"); 
...
--TRIGGER FUER LOCATIONS ENGLISCH    
    ...
    autonpcfunctions.AddTraderTrigger("[Mm]age [Aa]cademy","Yoo nub wunt go dere! Smelly mages beh dere. Dey nub honorable warriors beh but cowards! Dey whub burn yoo... ib yoo lucky beh!"); 
    autonpcfunctions.AddTraderTrigger("[Nn]orthmark","Dey lib on ottur side ob island far in north. Dey hab strrong warriors meh hab heard! And best beh dat dey nub like magic neithurrr - jus' bit like orcs, hurrr."); 
    ...
    autonpcfunctions.AddCondition("lang","english"); 
    autonpcfunctions.AddTraderTrigger("[Tt]roll['s].*[Bb]ane","Oomie town Troll's Bane beh biggest town on Gobaith. Though, orcs ususally get in trouble in here! Beh careful when passing town gates!"); 
    autonpcfunctions.AddCondition("lang","english"); 
    autonpcfunctions.AddTraderTrigger("[Vv]arshikar","Desert town Varshikar beh far abay from here! Orcs hab peace wit dem! Treat dem fair and dey whub treat yoo fair toos! But beh careful ob mages in desert town!"); 
    autonpcfunctions.AddCondition("lang","english"); 
    autonpcfunctions.AddTraderTrigger("[Dd]esert.*town","Desert town Varshikar beh far abay from here! Orcs hab peace wit dem! Treat dem fair and dey whub treat yoo fair toos! But beh careful ob mages in desert town!"); 
...
--SONSTIGE TRIGGER 
    autonpcfunctions.AddTraderTrigger("[Cc]lan", "Yubba, dis beh embassy ob strong orc clan! Tell meh clan name and meh whub open gate fer yoo!"); 
    ...
    autonpcfunctions.AddTraderTrigger("Tor", "Du wollen dass mir machen Tor auf? Dann du mir sagen Losungswort!"); 
    autonpcfunctions.AddTraderTrigger("Gate", "Yoo wunt meh open da gate? Den tell meh da keyword!"); 
...
--TRIGGER FÜR LOCATIONS DEUTSCH 
    ...
    autonpcfunctions.AddCondition("lang","german"); 
    autonpcfunctions.AddTraderTrigger("[Tt]roll['s].*[Bb]ane","Menschenstadt in Mitte der Insel du fragen nach? Groß und hässlich sie sein! Orkse nicht gern gesehen heir! Nim Waffen mit, wenn du in Stadt müssen!"); 
    autonpcfunctions.AddCondition("lang","german"); 
    autonpcfunctions.AddTraderTrigger("[Vv]arshikar","Meisten Wesen dort dumm und stinkig - aber Clanführer, Grrrypus, Ehre haben! Sei gut zu Wüstenvolk, dann sie gut zu Orks sind!"); 
    autonpcfunctions.AddCondition("lang","german"); 
