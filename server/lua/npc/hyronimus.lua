...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(400 ,253 ,2 ,8  ,3 ,{3}  ,{33}   ,0   ,0       ); -- raw bluestone
    trader_functions.AddTraderItem(500  ,329 ,30,0 ,15 ,{3} ,{33}   ,0   ,0       ); -- ink
    ...
    functions.AddTraderTrigger("[Mm]ission","My friend, I am selling potions to adventurers who fight the evil in the dungeon of Hellbriar..");
    functions.AddTraderTrigger("[Aa]uftrag","Mein Freund, ich verkaufe Tränke an alle Abenteurer, die die Hölle von Briar betreten.");
    ...
    functions.AddTraderTrigger("[Ww]hat.+sell","I cannot offer you much, but my potions.");
    functions.AddTraderTrigger("[Ww]as.+verkaufen","Ich kann nicht viel Anbieten. Vielleicht ein paar Tränke.");
    ...
    functions.AddTraderTrigger("[Ww]ho.+[Yy]ou","I am Brother "..thisNPC.name.." of the White Flame.");
    functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Ich bin Bruder "..thisNPC.name.." von der Weißen Flamme.");
    functions.AddTraderTrigger("[Hh]ellbriar","The foul armies of death and decay live in this area.");
    functions.AddTraderTrigger("[Hh]ölle","Die Armeen des Todes und der Finsternis leben in diesem Gebiet.");
