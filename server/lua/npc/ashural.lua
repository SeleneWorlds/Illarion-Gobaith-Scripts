...
-- Queststatus = 3
    ...
    autonpcfunctions.AddCondition("qpg","=",3);
    autonpcfunctions.AddConsequence("qpg",4);
    autonpcfunctions.AddTraderTrigger("why","My mother used to tell me stories about this wonderful flower. But now she passed out, and I have no memories of her. The flower can server as one.");
    autonpcfunctions.AddCondition("qpg","=",3);
-- Queststatus = 4
