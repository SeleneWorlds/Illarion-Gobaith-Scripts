...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(5   ,155 ,48,0  ,48,{3}  ,{33}   ,0   ,0       ); -- sibanac
    trader_functions.AddTraderItem(75  ,2744,6 ,0  ,6 ,{4,6},{44,66},0   ,0       ); -- pipe
    trader_functions.AddTraderItem(12  ,1909,0 ,8  ,11,{5}  ,{50}   ,0   ,0       ); -- beer
    trader_functions.AddTraderItem(0   ,1318,0 ,15 ,11,{5}  ,{50}   ,0   ,0       ); -- elven wine
    trader_functions.AddTraderItem(400 ,332 ,3 ,80 ,9 ,{4,6},{44,66},0   ,0       ); -- harp
    trader_functions.AddTraderItem(500 ,335 ,3 ,100,9 ,{4,6},{44,66},0   ,0       ); -- lute
    trader_functions.AddTraderItem(40  ,333 ,5 ,6  ,8 ,{4,6},{44,66},0   ,0       ); -- horn
    trader_functions.AddTraderItem(40  ,150 ,23,3  ,43,{4,6},{44,66},0   ,0       ); -- fir seedling
    trader_functions.AddItemTrigger("[Bb]aby.+[Ff]ir.+[Tt]ree");
    trader_functions.AddItemTrigger("[Tt]annenbaum.+[Kk]ind");
    trader_functions.AddTraderItem(55  ,51  ,6 ,5  ,12,{4,6},{44,66},0   ,0       ); -- bucket

    TraderCopper=400;

    functions.AddTraderTrigger("[Gg]reet","Hello sunshine!");
    functions.AddAdditionalTrigger("[Hh]ello");
    functions.AddTraderTrigger("[Gg]r[uü][sß+]","Hallo Sonnenschein!");
    functions.AddAdditionalTrigger("[Hh]allo");
    functions.AddAdditionalText("Hallöchen Sonnenschein");
    functions.AddTraderTrigger("[Ww]hat.+sell","I don't sell anything, but I trade plants, pipes, beer, elven wine, baby fir trees, buckets, and nice noise-makers for those shiny things");
    functions.AddTraderTrigger("[Ww]as.+verkauf","Ich verkaufe nichts, aber ich handel mit Pflanzen, Pfeifen, Bier, Elbenwein, Tannen Kindern, Eimern und nette Geräusche Macher für diese glitzernden Stückchen");
    functions.AddTraderTrigger("[Pp]lants","Yes, plants. I have a sibanac farm right here and pipes to go with it.");
    functions.AddTraderTrigger("[Pp]flanz","Ja. Pflanzen. Ich habe hier eine Sibanac Farm und Pfeifen um es zu rauchen.");
    functions.AddTraderTrigger("[Ww]hat.+do","I watch plants grow.");
    functions.AddTraderTrigger("[Ww]as.+[mt][au][cst]","Ich sehe den Pflanzen beim Wachsen zu.");
    functions.AddTraderTrigger("[Rr]umor","You talking about rumors? I have a fact to tell you, much better than rumors. The other day I saw gnolls dancing in the moonlight. I think they were having fun.");
    functions.AddTraderTrigger("[Gg]erüch","Du sprichst von Gerüchten? Ich habe etwas wahres was viel besser ist. Ich habe an einem anderen Tag Gnolle, im Mondlicht tanzen sehen. Ich denke sie hatten Spass.");
    functions.AddTraderTrigger("[Nn]ews","You interested in the latest news? A priest of Sirani told me that the goddess herself told his cousin that all spiders should be loved as our friends. That, my friend, is what happens when you mix 'shrooms with Sibanac.");
    functions.AddTraderTrigger("[Nn]euigkeit","Du bist an Neuigkeiten interessiert? Ein Priesterin von Sirani hat mir gesagt das ihr Göttin persönlich, ihrem Cousin gesagt hat, das alle Spinnen von unseren Freunden geliebt werden sollen. Das mein Freund, passiert wenn man Pilze und Sibanac mischt.");
    functions.AddTraderTrigger("[Ww]hat.+buy","I'll give you round shiny things for cylindrical vessels containing hop-flavored brew, or that sweet elven stuff. Ill even trade buckets, harps, lutes, or even horns! I can get a nice fir tree seedling! Isnt a tree much nicer than copper?");
    functions.AddTraderTrigger("[Ww]as.+%skauf","Ich gebe dir diese runden glitzernden Dinger für zylindrische Gefäße, befüllt mit, mit Hopfen gewürztem, Gebräu oder mit dem süßen Elbenzeugs. Ich handle auch mit Eimern und Instrumenten. Und ich kauf auch Tannen Setzlinge.");
    functions.AddTraderTrigger("[Ii]'m.+","Good for you, sunshine");
    functions.AddTraderTrigger("[Ii]ch.+bin","Gut für dich, Sonnenschein");
    functions.AddTraderTrigger("[Bb]aby [Ff]ir [Tt]rees","Yes, I sell baby fir trees. You might call them fir tree seedlings. I buy them, too.");
    functions.AddTraderTrigger("[Tt]annenbaum.+[Kk]ind","Ja. Ich verkaufe Tannenbaum Kinder. Du sagst vielleicht Tannen Baum Setzlinge dazu. Die kaufe ich auch.");
    functions.AddTraderTrigger("[Ff]arewell","Farewell, sunshine");
    functions.AddAdditionalTrigger("[Gg]oodbye");
    functions.AddAdditionalText("Bye, sunshine");
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Auf bald, Sonnenschein.");
