...
--------------------------------------------- *** EDIT BELOW HERE ***--------------------------------------
	...
	trader_functions.AddTraderItem(50  ,2680 ,50,0  ,50,{5}  ,{55},0   ,0       ); -- blue dye
    trader_functions.AddTraderItem(30  ,2681 ,50,0  ,50,{5}  ,{55},0   ,0       ); -- red dye
    trader_functions.AddTraderItem(30  ,2682 ,50,0  ,50,{3}  ,{33},0   ,0       ); -- yellow dye
    trader_functions.AddTraderItem(30  ,2679 ,50,0  ,50,{5}  ,{55},0   ,0       ); -- green dye
    trader_functions.AddTraderItem(30  ,2678 ,50,0  ,50,{5}  ,{55},0   ,0       ); -- black dye
    trader_functions.AddTraderItem(30  ,2683 ,50,0  ,50,{5}  ,{33},0   ,0       ); -- grey dye
    trader_functions.AddTraderItem(50  ,58   ,50,0  ,50,{5,7},{77,90},0,0       ); -- mortar
    trader_functions.AddTraderItem(50  ,2781 ,50,5  ,50,{5,7},{77,90},0,0       ); -- stirring rod
    ---------npc.base.trader_functions.Buying of ressources for potions and dyes
    trader_functions.AddTraderItem(0   ,51   ,200 ,2  ,30,{5} ,{55},0   ,0       ); -- empty bucket
    trader_functions.AddTraderItem(0   ,253  ,200 ,10 ,50,{5} ,{55},0   ,0       ); -- raw bluestone
    trader_functions.AddTraderItem(0   ,21   ,200 ,1  ,50,{5} ,{55},0   ,0       ); -- coal
    trader_functions.AddTraderItem(0   ,136  ,200 ,1  ,50,{3} ,{33},0   ,0       ); -- angerberries
    trader_functions.AddTraderItem(0   ,157  ,200 ,1  ,50,{5} ,{55},0   ,0       ); -- rotten bark
    trader_functions.AddTraderItem(0   ,161  ,200,1  ,50,{5} ,{55},0   ,0       ); -- herder mushroom
    trader_functions.AddTraderItem(10  ,148  ,200,1  ,50,{3} ,{33},0   ,0       ); -- firnis blossom
    trader_functions.AddTraderItem(10  ,153  ,200,1  ,50,{3} ,{33},0   ,0       ); -- foot leaf
    trader_functions.AddTraderItem(10  ,133  ,200,1  ,50,{3} ,{33},0   ,0       ); -- sun herb
    trader_functions.AddTraderItem(10  ,144  ,200,1  ,50,{3} ,{33},0   ,0       ); -- virgins weed
    trader_functions.AddTraderItem(10  ,145  ,200,1  ,50,{3} ,{33},0   ,0       ); -- heat flower
    trader_functions.AddTraderItem(10  ,155  ,200,1  ,50,{3} ,{33},0   ,0       ); -- sibanac leaf
    trader_functions.AddTraderItem(15  ,178  ,200,1  ,50,{3} ,{33},0   ,0       ); -- white cloth/bandage
    trader_functions.AddTraderItem(60  ,2744 ,50 ,5  ,10,{3} ,{33},0   ,0       ); -- pipe

    TraderCopper=5000;

    functions.AddTraderTrigger("[Gg]reetings","Hiho. How can I help you?");
    functions.AddAdditionalTrigger("[Hh]ello");
    functions.AddAdditionalText("Hello. Do you need something? I'm alchemist and dyes of all colors. All are selfmade!");
    functions.AddTraderTrigger("[Gg]rü[ßs]+e","Hiho! Wie kann ich dir helfen? Ich habe allerhand Farben. Alle selbst gemacht!");
    functions.AddAdditionalTrigger("[Hh]allo");
    functions.AddAdditionalText("Hallo. Wer bist du denn?.");
    functions.AddTraderTrigger("[Yy]ou.+[Tt]rader","Yes, i trade with dyes and ingredients to make them.");
    functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh][äa]ndler","Ja, ich handle mit Farben und Zutaten zur Herstellung von Farben.");
    functions.AddTraderTrigger("[Yy]ou.+[Hh]ealer","No, i am not. I am alchemist and sell dyes");
    functions.AddTraderTrigger("[DdIi][uh]r*.+[Hh]eiler","Nein bin ich nicht. Ich bin Alchemist und verkaufe Farben.");
    functions.AddTraderTrigger("[Ww]hat.+sell","Do you want that i list my wares? Here take a look at the best dyes you can find!");
    functions.AddTraderTrigger("[Ww]as.+verkauf","Willst du eine Liste meiner Waren sehen? Hier, schau. Das sind die besten Farben die du finden wirst");
    functions.AddTraderTrigger("[Ww]hat.+[Ww]ares","I trade with dyes and ingredients to make them.");
    functions.AddTraderTrigger("[Ww]as.+[Ww]aren","Ich handele mit Farben und Zutaten zu deren Herstellung.");
    functions.AddTraderTrigger("[Ww]hat.+[Pp]otion","I have no potions anymore. I only trade with dyes and ingredients to make them.");
    functions.AddTraderTrigger("[Ww]as.+[Tt]ränke","Ich habe keine Tränke mehr. Ich handele nur noch mit Farben und Zutaten zu deren Herstellung.");
    functions.AddTraderTrigger("[Ww]hat.+[Cc]loth","I don't trade with cloth anymore. The business with cloths didn't work.");
    functions.AddTraderTrigger("[Ww]as.+[Kk]leidung","Ich habe keine Kleidung mehr im Angebot. Das Geschäft mit den abgetragenen Klamotten lief nicht gut.");
    functions.AddTraderTrigger("[Ww]hat.+[Mm]ore","I need different tools and goods to make dyes");
    functions.AddTraderTrigger("[Ww]as.+[Mm]ehr","Ich brauche verschiedene Werkzeuge und Sachen um Farben herzustellen.");
    functions.AddTraderTrigger("[Ww]hat.+[Dd]ye","I'm an alchemist and prepare differnet dyes. You are interested in red, blue, yellow or other?.");
    functions.AddTraderTrigger("[Ww]as.+[Ff]arbe","Ja, ich bin Alchemist und verkaufe verschiedene Farben. Bist du vielleicht an Rot oder Blau interessiert? Was anderes?");
    functions.AddTraderTrigger("[Gg]oodbye","Have a nice day. Oldra my bless you.");
    ...
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Schönen Tag noch! Oldra segne euch!");
    functions.AddAdditionalTrigger("[Bb]is.+[Bb]ald");
    functions.AddAdditionalText("Schönen Tag!");
    functions.AddTraderTrigger("[Ww]ho.+you?","My name is Tony Baggins. I am an alchemist and I work here. But I come from Greenbriar. Do you know my home village?");
    functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Ich bin Tony Baggins. Ich bin Alchemist und arbeite hier. Aber ich komme von Greenbriar. Kennst du mein Heimatdorf?");
    functions.AddTraderTrigger("I'm .+","Nice to meet you. Do you need my help?");
    functions.AddTraderTrigger("[Ii]ch.+[Bb]in","Freut mich! Kann ich dir helfen?");
    ...
    functions.AddTraderTrigger("[Hh]ilfe","'Welche Waren verkauft ihr', 'Ich möchte <Anzahl> <Ware> kaufen', 'Ich möchte <Ware> kaufen', 'Ich möchte <Anzahl> <Ware> verkaufen', 'Was ist der Preis von <Ware>','Was zahlt ihr für <Ware>', 'Was kauft ihr?', 'Erzähl über <etwas>'");
