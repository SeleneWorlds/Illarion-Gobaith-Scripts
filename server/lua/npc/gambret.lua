...
function M.initializeNpc()
    ...
    trader_functions.AddTraderItem(30  ,227 ,20 ,2 ,30,{4,6},{77,90},0   ,0       ); -- cooking spoon
    trader_functions.AddTraderItem(30  ,121 ,20 ,2 ,30,{4,6},{77,90},0   ,0       ); -- Ofenschieber
    trader_functions.AddTraderItem(30  ,118 ,20 ,2 ,30,{4,6},{77,90},0   ,0       ); -- Nudelholz
    trader_functions.AddTraderItem(10  ,2952,20 ,2 ,36,{3}  ,{33}   ,0   ,0       ); -- plate X
    trader_functions.AddTraderItem(10  ,2935,20 ,2 ,36,{3}  ,{33}   ,0   ,0       ); -- soup bowl X
    trader_functions.AddTraderItem(0   ,2647,0 ,5  ,36,{3}  ,{33}   ,0   ,0       ); -- cutlery X
    trader_functions.AddTraderItem(0   ,1908,0 ,1  ,36,{3}  ,{33}   ,0   ,0       ); -- beer mug X
    trader_functions.AddTraderItem(0   ,2185,0 ,2  ,36,{3}  ,{33}   ,0   ,0       ); -- wooden cup X
    trader_functions.AddTraderItem(0   ,223 ,0 ,6  ,36,{3}  ,{33}   ,0   ,0       ); -- iron goblet X
    trader_functions.AddTraderItem(0   ,1858,0 ,4  ,36,{3}  ,{33}   ,0   ,0       ); -- goblet X
    trader_functions.AddTraderItem(0   ,164 ,0 ,1  ,36,{3}  ,{33}   ,0   ,0       ); -- big empty bottle X
    trader_functions.AddTraderItem(0   ,1317,0 ,2  ,36,{3}  ,{33}   ,0   ,0       ); -- empty bottle X
    trader_functions.AddTraderItem(0   ,2498,0 ,3  ,36,{3}  ,{33}   ,0   ,0       ); -- grey bottle X
    trader_functions.AddTraderItem(0   ,2055,0 ,3  ,36,{3}  ,{33}   ,0   ,0       ); -- glass X

    TraderCopper=400;

    functions.AddTraderTrigger("[Hh]ello","Hello");
    functions.AddAdditionalTrigger("[Gg]reetings");
    functions.AddAdditionalText("Greetings");
    functions.AddTraderTrigger("[Hh]allo","Hallo");
    functions.AddAdditionalTrigger("[Gg]r[üu][ßs]+");
    functions.AddAdditionalText("Grüße");
    functions.AddTraderTrigger("[Ww]hat.+buy","Ill buy cutlery, plates and bowls, cups, goblets, bottles and cooking tools.");
    functions.AddTraderTrigger("[Ww]as.+%skauf","Ich kaufe Besteck, Teller und Schüsseln, Becher, Kelche, diverse Flaschen und Kochutensilien.");
    functions.AddTraderTrigger("[Ww]hat.+do","I buy table supplies for the tavern");
    functions.AddTraderTrigger("[Ww]as.+[tm][ua][tsc]","Ich kaufe Tisch Gedeck für die Taverne");
    functions.AddTraderTrigger("[Ww]ho.+you","Gambret.");
    functions.AddTraderTrigger("[Ww]er.+[DdIi][uh]r*","Gambret.");
    functions.AddTraderTrigger("[Ii][' ]*m.+","Alright then. Have anything to sell me?");
    functions.AddTraderTrigger("[Ii]ch.+[Bb]in","In Ordnung. Habt ihr was, das ihr mir verkaufen könntet?");
    functions.AddTraderTrigger("[Bb]ye","Goodbye");
    functions.AddAdditionalTrigger("[Ff]arewell");
    functions.AddAdditionalText("Goodbye");
    functions.AddTraderTrigger("[Aa]uf.+[Bb]ald","Auf bald");
