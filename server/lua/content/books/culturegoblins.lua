...
function M.loadBook(toData)
    ...
    base_books.AddEnglishBookText("We, the goblins, are somewhat related to orcs I think. Though, we are more agile and a bit smarter, of course. We have big eyes, ears, and mouths. Our whole body is covered in short fur.",0,0,toData);
    base_books.AddEnglishBookText("Though, our faces have a leathery greenish skin. We have squeaky voices, or so I am told. I once was compared to a baby crying or whining for something he just lost. I don't believe it.",0,0,toData);
    base_books.AddEnglishBookText("We are somewhat small, and not too strong. We live in loose families and leadership varies from one another. We are not evil, no, but we aren't boring and do not like boring religions.",0,0,toData);
    base_books.AddEnglishBookText("I've been told I dress rather badly and sometimes smell, but I don't think so. Also, that my eating habits are bad and what I eat is not tasty, but I find it rather delicious.",0,0,toData);
    base_books.AddEnglishBookText("Apparently a well aged, rusty dagger isn't food to humans, but they should try it some time.",0,0,toData);
    base_books.AddEnglishBookText("Sometimes we are caught and enslaved by orcish tribes, we try to stay away from them though. We scare easily, but not to halflings, they aren't scary at all. Not like a tall elf.",0,0,toData);
    base_books.AddEnglishBookText("We have great smell and taste, and are very good with our hands. We make good alchemists and craftsmen, or even thiefs. I am not one though, I swear.",0,0,toData);
    base_books.AddEnglishBookText("We don't like magic, but some are talented in it. I hear there is this wise high lor-angurian mage. Maybe, it could just be a rumor!",0,0,toData);
    base_books.AddEnglishBookText("We don't live in towns, but small camps. Some people find these camps dangerous, I don't know why. Throwing a rock at someone with a sling isn't that bad!",0,0,toData);
    base_books.AddEnglishBookText("In Albar, us goblins are forced to fight other animals. Sometimes we are just used as slaves though, poor goblins.",0,0,toData);
...
function loadTitle(toData)
    base_books.AddGermanBookTitle("Buch mit dem Titel \"Das Volk der Goblins\"",toData);
    base_books.AddEnglishBookTitle("Book with the title \"Goblin Culture\"",toData);
end;
