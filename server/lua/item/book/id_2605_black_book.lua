...
function M.UseItem(User, SourceItem, TargetItem, Counter, Param)
    if ( TargetItem.id == 266 ) or ( TargetItem.id == 267 ) then
        ...
        if base_books.InitBook() then
            ...
            base_books.AddEnglishBookText("The diary of Noira Liv",0,0,0);
            base_books.AddEnglishBookText("These are the notes of Noira Liv, high priestess of Eldan.",0,0,0);
            base_books.AddEnglishBookText("Preface:",0,0,0);
            base_books.AddEnglishBookText("The age of fighting has passed. The old gods abandoned us. They crossed the sea. I am the last high priestess of Eldan. This is my story.",0,0,0);
            base_books.AddEnglishBookText("May this legacy outlast the times, may the sealed altars fall into oblivion: One day the heirs will come.",0,0,0);
            base_books.AddEnglishBookText("The old books will be found and old teachings will mix up with new one, because the knowledge doesn't die as long as we are alive, it just sleeps. The sleep may last long, very long.",0,0,0);
            base_books.AddEnglishBookText("Chapter I: The search for Eldan:",0,0,0);
            base_books.AddEnglishBookText("Today I met a disciple of Findari. He advised me to document the walking tour to Murinaa, as a memory.",0,0,0);
            base_books.AddEnglishBookText("Murinaa: There still lays a journey of a few days between me and the city but nevertheless the splendid city is yet to be seen far away above the glittering sand.",0,0,0);
            base_books.AddEnglishBookText("Like many of the candidates for the priesthood, I am attracted to Murinaa, the next bigger city in which there are the shrines of all the gods.",0,0,0);
            base_books.AddEnglishBookText("The more I approach Murinaa, the more followers of Bragon, Ushara, Eldan, Tanora and Findari cross my way. There are not hundreds of them but nevertheless a few dozen.",0,0,0);
            base_books.AddEnglishBookText("Finally in Murinaa: The library is gigantic. I have found and read the book of the priests of Eldan. It is very mysterious.",0,0,0);
            base_books.AddEnglishBookText("It seems, that I am expected to find the prayer for the consecration on my own. My only clue is the Book of the priests of Eldan.",0,0,0);
            base_books.AddEnglishBookText("This book is an enigma for me. And the consecrations approach. Unstoppable. How shall i read it?!",0,0,0);
            base_books.AddEnglishBookText("One of the novices noticed my trouble in the library today. He said that there were exactly five gods, as if I didn't know that.",0,0,0);
            base_books.AddEnglishBookText("Besides he talked about a cycle of creation. Obviously he wanted to give me a hint. I wonder what he meant.",0,0,0);
            base_books.AddEnglishBookText("I have made an interesting observation: every fifth day the light falls through a gap in the ceiling exactly onto the book of the priests of Eldan.",0,0,0);
            base_books.AddEnglishBookText("I observed that this is also valid for the books of the other priests of the five.",0,0,0);
            base_books.AddEnglishBookText("Finally I managed to snatch the prayer from the text in the book.",0,0,0);
            base_books.AddEnglishBookText("However I have to make Eldan a sacrifice during the consecration. The master of the ritual emphasized that I have to sacrifice something to Eldan, that he likes.",0,0,0);
            base_books.AddEnglishBookText("This was the most incredible day in my life: I held the bottle in my hand and called Eldan to accept my sacrifice.",0,0,0);
            base_books.AddEnglishBookText("After that a powerful suction grasped me and it draw me far away. It was an incredible feeling. As i arrived there, I saw a large altar room in front of me.",0,0,0);
            base_books.AddEnglishBookText("I suppose it was a secret altar room of Eldan in Nabranoo, the city of the gods. This room looked like it was built for the eternity.",0,0,0);
            base_books.AddEnglishBookText("There I spoke the prayer, kneeling in front of the altar, and I could feel Eldans look on me as he appointed me to a novice.",0,0,0);
            base_books.AddEnglishBookText("Chapter II: The journey continues:",0,0,0);
            base_books.AddEnglishBookText("You don't understand this language",0,0,0);
            
            ---------------------
            
            base_books.AddLanguage("dwarf language",1);

            base_books.AddEnglishBookText("Slashing weapons\n\nThe axe is the mother of all weapons, that's why dwarves are using them.",0,0,1);
            base_books.AddEnglishBookText("With these weapons you can perform mighty attacks and, used with enough skill, they replace every shield.",0,0,1);
            base_books.AddEnglishBookText("Dwarvenaxe",2660,0,1); -- ### dwarvenaxe ###
            base_books.AddEnglishBookText("The most used axe by dwarves, it unites all attributes a real dwarveweapon needs. Power, rapidness and dexterity",0,0,1);
            base_books.AddEnglishBookText("Power, with the dwarvenaxe you can perform mighty attacks.",0,0,1);
            base_books.AddEnglishBookText("Rapidness, because of it's balanced production the dwarvenaxe can be handled quick and easy.",0,0,1);
            base_books.AddEnglishBookText("Dexterity, the thin handle and the rakish blade gives a precise handling to the axe.",0,0,1);
            base_books.AddEnglishBookText("Legends tell that there are magicial dwarvenaxes too.",0,0,1);
            base_books.AddEnglishBookText("Waraxe",383,0,1); -- ### waraxe ###
            base_books.AddEnglishBookText("The waraxe is qualified for battles and unites all important attributes of an axe.",0,0,1);
            base_books.AddEnglishBookText("But because of it's production and it's shape it'll never reach tha quality of a dwarvenaxe, smithed by dwarven smiths.",0,0,1);
            base_books.AddEnglishBookText("Legends tell that there are magicial and fire waraxes.",0,0,1);
            base_books.AddEnglishBookText("Battleaxe",2629,0,1); -- ### battleaxe ###
            base_books.AddEnglishBookText("The battleaxe is not realy a good axe, that's why dwarves use them mostly for training because the damage causes it's causes isn't big.",0,0,1);
			...
			base_books.AddEnglishBookText("Everyone who wants to make use of my 'services', approach Pilnock Wimnab and ask for me. \n\n ~The Dark Brewer~",2499,0,2);
			
			base_books.AddGermanBookText("Jeder, der meine 'Dienste' in Anspruch nehmen will, soll sich an Pilnock Wimnab wenden und nach mir fragen. \n\n ~Der Dunkle Brauer~",2499,0,2);
			--------------------------------------------------
			...
			base_books.AddEnglishBookText("Fish filet\n Basic ingredients: trout filets, cabbage, tomatoes\n Easy, 25 cps.",2459,0,3); -- ### fish filet dish ###
			base_books.AddEnglishBookText("Chop two cups of cabbage finely and start cooking it adding a glass of white wine.",0,0,3);
			base_books.AddEnglishBookText("Dice two tomatoes and add to the cabbage. Mix in some herbs; I love sand berries with trout! Let it simmer until the cabbage is tender. ",2459,0,3); -- ### fish fillet dish ###
			base_books.AddEnglishBookText("Take a nice fresh trout and fillet it delicately. Put the fillets, with the skin up, on the simmering vegetables. Cover and let cook a few minutes, until the skin comes off the filets.",73,0,3); -- ### trout ###
			...
			base_books.AddEnglishBookText("Take a couple of thick salmon steaks and roast them on both sides for a few minutes, until tender. You could also poach them in a vegetable broth.",355,0,3); -- ### salmon ###
			...
			base_books.AddEnglishBookText("Fry thin slices of steak in a black butter, flank steak is the best. Do not overcook it!",2940,0,3); -- ### steak ###
			...
			base_books.AddEnglishBookText("Put the rabbit meat with the vegetables and some liquid into a deep pie plate lined with dough. Bake in a hot oven until the liquid has evaporated.",555,0,3); -- ### rabbit dish ###
			...
			base_books.AddEnglishBookText("Roast some lamb cutlets over a lively fire until browned and juicy. Serve with the vegetables and muffins.",2934,0,3); -- ### lamb meat ###
			base_books.AddEnglishBookText("The lamb cutlets would go well with a lively mature wine or a rather strong mead.",2500,0,3); -- ### bottle of wine###
...
function M.LookAtItem(User,Item)
    if base_books.InitTitle() then
        base_books.AddEnglishBookTitle("Book with the title \"Diary of Noira Liv\"",0);
        base_books.AddGermanBookTitle("Buch mit dem Titel \"Tagebuch von Noira Liv\"",0);
        
        base_books.AddEnglishBookTitle("Book with the title \"Warguide of the Dwarves I\"",1);
        base_books.AddGermanBookTitle("Buch mit dem Titel \"Kriegshandbuch der Zwerge I\"",1);
		
		base_books.AddEnglishBookTitle("",2);
		base_books.AddGermanBookTitle("Vergilbtes schwarzes Buch",2);
		
		base_books.AddEnglishBookTitle("Book with the title \"Cooking in Illarion, volume 1\n Fish and Meat\" Leva Beliu",3);
		base_books.AddGermanBookTitle("Buch mit dem Titel \"Kochen auf Illarion, Band 1\n Fisch und Fleisch \" Leva Beliu",3);
