...
if (MonID==101) then --Mummy, Level: 2, Armourtype: -, Weapontype: slashing
    ...
    elseif (MonID==102) then --Agressive Mummy, Level: 3, Armourtype: -, Weapontype: concussion
    ...
    elseif (MonID==103) then --Slow Mummy, Level: 2, Armourtype: -, Weapontype: concussion
    ...
    elseif (MonID==105) then --Smelly Mummy, Level: 2, Armourtype: -, Weapontype: slashing

        --Category 1: Armor

        local done=drop.AddDropItem(177,1,20,(100*math.random(1,2)+math.random(11,22)),0,1); --yellow cloth
        if not done then done=drop.AddDropItem(55,1,10,(100*math.random(1,2)+math.random(11,22)),0,1); end --green cloth
        ...
        local done=drop.AddDropItem(63,1,20,(100*math.random(1,2)+math.random(11,22)),0,2); --entrails
        if not done then done=drop.AddDropItem(2746,1,10,(100*math.random(1,2)+math.random(11,22)),0,2); end --razor blade
        ...
        if not done then done=drop.AddDropItem(1,1,10,(100*math.random(1,2)+math.random(11,22)),0,3); end --serinjah sword
